...
`).replace(Ad,``)}function Md(e,t){return t=jd(t),jd(e)===t}function $(e,t,n,r,a,o){switch(n){case`children`:typeof r==`string`?t===`body`||t===`textarea`&&r===``||$t(e,r):(typeof r==`number`||typeof r==`bigint`)&&t!==`body`&&$t(e,``+r);break;case`className`:Lt(e,`class`,r);break;case`tabIndex`:Lt(e,`tabindex`,r);break;case`dir`:case`role`:case`viewBox`:case`width`:case`height`:Lt(e,n,r);break;case`style`:nn(e,r,o);break;case`data`:if(t!==`object`){Lt(e,`data`,r);break}case`src`:case`href`:if(r===``&&(t!==`a`||n!==`href`)){e.removeAttribute(n);break}if(r==null||typeof r==`function`||typeof r==`symbol`||typeof r==`boolean`){e.removeAttribute(n);break}r=sn(``+r),e.setAttribute(n,r);break;case`action`:case`formAction`:if(typeof r==`function`){e.setAttribute(n,`javascript:throw new Error('A React form was unexpectedly submitted. If you called form.submit() manually, consider using form.requestSubmit() instead. If you\\'re trying to use event.stopPropagation() in a submit event handler, consider also calling event.preventDefault().')`);break}if(typeof o==`function`&&(n===`formAction`?(t!==`input`&&$(e,t,`name`,a.name,a,null),$(e,t,`formEncType`,a.formEncType,a,null),$(e,t,`formMethod`,a.formMethod,a,null),$(e,t,`formTarget`,a.formTarget,a,null)):($(e,t,`encType`,a.encType,a,null),$(e,t,`method`,a.method,a,null),$(e,t,`target`,a.target,a,null))),r==null||typeof r==`symbol`||typeof r==`boolean`){e.removeAttribute(n);break}r=sn(``+r),e.setAttribute(n,r);break;case`onClick`:r!=null&&(e.onclick=cn);break;case`onScroll`:r!=null&&Q(`scroll`,e);break;case`onScrollEnd`:r!=null&&Q(`scrollend`,e);break;case`dangerouslySetInnerHTML`:if(r!=null){if(typeof r!=`object`||!(`__html`in r))throw Error(i(61));if(n=r.__html,n!=null){if(a.children!=null)throw Error(i(60));e.innerHTML=n}}break;case`multiple`:e.multiple=r&&typeof r!=`function`&&typeof r!=`symbol`;break;case`muted`:e.muted=r&&typeof r!=`function`&&typeof r!=`symbol`;break;case`suppressContentEditableWarning`:case`suppressHydrationWarning`:case`defaultValue`:case`defaultChecked`:case`innerHTML`:case`ref`:break;case`autoFocus`:break;case`xlinkHref`:if(r==null||typeof r==`function`||typeof r==`boolean`||typeof r==`symbol`){e.removeAttribute(`xlink:href`);break}n=sn(``+r),e.setAttributeNS(`http://www.w3.org/1999/xlink`,`xlink:href`,n);break;case`contentEditable`:case`spellCheck`:case`draggable`:case`value`:case`autoReverse`:case`externalResourcesRequired`:case`focusable`:case`preserveAlpha`:r!=null&&typeof r!=`function`&&typeof r!=`symbol`?e.setAttribute(n,``+r):e.removeAttribute(n);break;case`inert`:case`allowFullScreen`:case`async`:case`autoPlay`:case`controls`:case`default`:case`defer`:case`disabled`:case`disablePictureInPicture`:case`disableRemotePlayback`:case`formNoValidate`:case`hidden`:case`loop`:case`noModule`:case`noValidate`:case`open`:case`playsInline`:case`readOnly`:case`required`:case`reversed`:case`scoped`:case`seamless`:case`itemScope`:r&&typeof r!=`function`&&typeof r!=`symbol`?e.setAttribute(n,``):e.removeAttribute(n);break;case`capture`:case`download`:!0===r?e.setAttribute(n,``):!1!==r&&r!=null&&typeof r!=`function`&&typeof r!=`symbol`?e.setAttribute(n,r):e.removeAttribute(n);break;case`cols`:case`rows`:case`size`:case`span`:r!=null&&typeof r!=`function`&&typeof r!=`symbol`&&!isNaN(r)&&1<=r?e.setAttribute(n,r):e.removeAttribute(n);break;case`rowSpan`:case`start`:r==null||typeof r==`function`||typeof r==`symbol`||isNaN(r)?e.removeAttribute(n):e.setAttribute(n,r);break;case`popover`:Q(`beforetoggle`,e),Q(`toggle`,e),It(e,`popover`,r);break;case`xlinkActuate`:Rt(e,`http://www.w3.org/1999/xlink`,`xlink:actuate`,r);break;case`xlinkArcrole`:Rt(e,`http://www.w3.org/1999/xlink`,`xlink:arcrole`,r);break;case`xlinkRole`:Rt(e,`http://www.w3.org/1999/xlink`,`xlink:role`,r);break;case`xlinkShow`:Rt(e,`http://www.w3.org/1999/xlink`,`xlink:show`,r);break;case`xlinkTitle`:Rt(e,`http://www.w3.org/1999/xlink`,`xlink:title`,r);break;case`xlinkType`:Rt(e,`http://www.w3.org/1999/xlink`,`xlink:type`,r);break;case`xmlBase`:Rt(e,`http://www.w3.org/XML/1998/namespace`,`xml:base`,r);break;case`xmlLang`:Rt(e,`http://www.w3.org/XML/1998/namespace`,`xml:lang`,r);break;case`xmlSpace`:Rt(e,`http://www.w3.org/XML/1998/namespace`,`xml:space`,r);break;case`is`:It(e,`is`,r);break;case`innerText`:case`textContent`:break;default:(!(2<n.length)||n[0]!==`o`&&n[0]!==`O`||n[1]!==`n`&&n[1]!==`N`)&&(n=an.get(n)||n,It(e,n,r))}}function Nd(e,t,n,r,a,o){switch(n){case`style`:nn(e,r,o);break;case`dangerouslySetInnerHTML`:if(r!=null){if(typeof r!=`object`||!(`__html`in r))throw Error(i(61));if(n=r.__html,n!=null){if(a.children!=null)throw Error(i(60));e.innerHTML=n}}break;case`children`:typeof r==`string`?$t(e,r):(typeof r==`number`||typeof r==`bigint`)&&$t(e,``+r);break;case`onScroll`:r!=null&&Q(`scroll`,e);break;case`onScrollEnd`:r!=null&&Q(`scrollend`,e);break;case`onClick`:r!=null&&(e.onclick=cn);break;case`suppressContentEditableWarning`:case`suppressHydrationWarning`:case`innerHTML`:case`ref`:break;case`innerText`:case`textContent`:break;default:if(!kt.hasOwnProperty(n))a:{if(n[0]===`o`&&n[1]===`n`&&(a=n.endsWith(`Capture`),t=n.slice(2,a?n.length-7:void 0),o=e[ht]||null,o=o==null?null:o[n],typeof o==`function`&&e.removeEventListener(t,o,a),typeof r==`function`)){typeof o!=`function`&&o!==null&&(n in e?e[n]=null:e.hasAttribute(n)&&e.removeAttribute(n)),e.addEventListener(t,r,a);break a}n in e?e[n]=r:!0===r?e.setAttribute(n,``):It(e,n,r)}}}function Pd(e,t,n){switch(t){case`div`:case`span`:case`svg`:case`path`:case`a`:case`g`:case`p`:case`li`:break;case`img`:Q(`error`,e),Q(`load`,e);var r=!1,a=!1,o;for(o in n)if(n.hasOwnProperty(o)){var s=n[o];if(s!=null)switch(o){case`src`:r=!0;break;case`srcSet`:a=!0;break;case`children`:case`dangerouslySetInnerHTML`:throw Error(i(137,t));default:$(e,t,o,s,n,null)}}a&&$(e,t,`srcSet`,n.srcSet,n,null),r&&$(e,t,`src`,n.src,n,null);return;case`input`:Q(`invalid`,e);var c=o=s=a=null,l=null,u=null;for(r in n)if(n.hasOwnProperty(r)){var d=n[r];if(d!=null)switch(r){case`name`:a=d;break;case`type`:s=d;break;case`checked`:l=d;break;case`defaultChecked`:u=d;break;case`value`:o=d;break;case`defaultValue`:c=d;break;case`children`:case`dangerouslySetInnerHTML`:if(d!=null)throw Error(i(137,t));break;default:$(e,t,r,d,n,null)}}Jt(e,o,c,l,u,s,a,!1);return;case`select`:for(a in Q(`invalid`,e),r=s=o=null,n)if(n.hasOwnProperty(a)&&(c=n[a],c!=null))switch(a){case`value`:o=c;break;case`defaultValue`:s=c;break;case`multiple`:r=c;default:$(e,t,a,c,n,null)}t=o,n=s,e.multiple=!!r,t==null?n!=null&&Xt(e,!!r,n,!0):Xt(e,!!r,t,!1);return;case`textarea`:for(s in Q(`invalid`,e),o=a=r=null,n)if(n.hasOwnProperty(s)&&(c=n[s],c!=null))switch(s){case`value`:r=c;break;case`defaultValue`:a=c;break;case`children`:o=c;break;case`dangerouslySetInnerHTML`:if(c!=null)throw Error(i(91));break;default:$(e,t,s,c,n,null)}Qt(e,r,a,o);return;case`option`:for(l in n)if(n.hasOwnProperty(l)&&(r=n[l],r!=null))switch(l){case`selected`:e.selected=r&&typeof r!=`function`&&typeof r!=`symbol`;break;default:$(e,t,l,r,n,null)}return;case`dialog`:Q(`beforetoggle`,e),Q(`toggle`,e),Q(`cancel`,e),Q(`close`,e);break;case`iframe`:case`object`:Q(`load`,e);break;case`video`:case`audio`:for(r=0;r<_d.length;r++)Q(_d[r],e);break;case`image`:Q(`error`,e),Q(`load`,e);break;case`details`:Q(`toggle`,e);break;case`embed`:case`source`:case`link`:Q(`error`,e),Q(`load`,e);case`area`:case`base`:case`br`:case`col`:case`hr`:case`keygen`:case`meta`:case`param`:case`track`:case`wbr`:case`menuitem`:for(u in n)if(n.hasOwnProperty(u)&&(r=n[u],r!=null))switch(u){case`children`:case`dangerouslySetInnerHTML`:throw Error(i(137,t));default:$(e,t,u,r,n,null)}return;default:if(rn(t)){for(d in n)n.hasOwnProperty(d)&&(r=n[d],r!==void 0&&Nd(e,t,d,r,n,void 0));return}}for(c in n)n.hasOwnProperty(c)&&(r=n[c],r!=null&&$(e,t,c,r,n,null))}function Fd(e,t,n,r){switch(t){case`div`:case`span`:case`svg`:case`path`:case`a`:case`g`:case`p`:case`li`:break;case`input`:var a=null,o=null,s=null,c=null,l=null,u=null,d=null;for(m in n){var f=n[m];if(n.hasOwnProperty(m)&&f!=null)switch(m){case`checked`:break;case`value`:break;case`defaultValue`:l=f;default:r.hasOwnProperty(m)||$(e,t,m,null,r,f)}}for(var p in r){var m=r[p];if(f=n[p],r.hasOwnProperty(p)&&(m!=null||f!=null))switch(p){case`type`:o=m;break;case`name`:a=m;break;case`checked`:u=m;break;case`defaultChecked`:d=m;break;case`value`:s=m;break;case`defaultValue`:c=m;break;case`children`:case`dangerouslySetInnerHTML`:if(m!=null)throw Error(i(137,t));break;default:m!==f&&$(e,t,p,m,r,f)}}qt(e,s,c,l,u,d,o,a);return;case`select`:for(o in m=s=c=p=null,n)if(l=n[o],n.hasOwnProperty(o)&&l!=null)switch(o){case`value`:break;case`multiple`:m=l;default:r.hasOwnProperty(o)||$(e,t,o,null,r,l)}for(a in r)if(o=r[a],l=n[a],r.hasOwnProperty(a)&&(o!=null||l!=null))switch(a){case`value`:p=o;break;case`defaultValue`:c=o;break;case`multiple`:s=o;default:o!==l&&$(e,t,a,o,r,l)}t=c,n=s,r=m,p==null?!!r!=!!n&&(t==null?Xt(e,!!n,n?[]:``,!1):Xt(e,!!n,t,!0)):Xt(e,!!n,p,!1);return;case`textarea`:for(c in m=p=null,n)if(a=n[c],n.hasOwnProperty(c)&&a!=null&&!r.hasOwnProperty(c))switch(c){case`value`:break;case`children`:break;default:$(e,t,c,null,r,a)}for(s in r)if(a=r[s],o=n[s],r.hasOwnProperty(s)&&(a!=null||o!=null))switch(s){case`value`:p=a;break;case`defaultValue`:m=a;break;case`children`:break;case`dangerouslySetInnerHTML`:if(a!=null)throw Error(i(91));break;default:a!==o&&$(e,t,s,a,r,o)}Zt(e,p,m);return;case`option`:for(var h in n)if(p=n[h],n.hasOwnProperty(h)&&p!=null&&!r.hasOwnProperty(h))switch(h){case`selected`:e.selected=!1;break;default:$(e,t,h,null,r,p)}for(l in r)if(p=r[l],m=n[l],r.hasOwnProperty(l)&&p!==m&&(p!=null||m!=null))switch(l){case`selected`:e.selected=p&&typeof p!=`function`&&typeof p!=`symbol`;break;default:$(e,t,l,p,r,m)}return;case`img`:case`link`:case`area`:case`base`:case`br`:case`col`:case`embed`:case`hr`:case`keygen`:case`meta`:case`param`:case`source`:case`track`:case`wbr`:case`menuitem`:for(var g in n)p=n[g],n.hasOwnProperty(g)&&p!=null&&!r.hasOwnProperty(g)&&$(e,t,g,null,r,p);for(u in r)if(p=r[u],m=n[u],r.hasOwnProperty(u)&&p!==m&&(p!=null||m!=null))switch(u){case`children`:case`dangerouslySetInnerHTML`:if(p!=null)throw Error(i(137,t));break;default:$(e,t,u,p,r,m)}return;default:if(rn(t)){for(var _ in n)p=n[_],n.hasOwnProperty(_)&&p!==void 0&&!r.hasOwnProperty(_)&&Nd(e,t,_,void 0,r,p);for(d in r)p=r[d],m=n[d],!r.hasOwnProperty(d)||p===m||p===void 0&&m===void 0||Nd(e,t,d,p,r,m);return}}for(var v in n)p=n[v],n.hasOwnProperty(v)&&p!=null&&!r.hasOwnProperty(v)&&$(e,t,v,null,r,p);for(f in r)p=r[f],m=n[f],!r.hasOwnProperty(f)||p===m||p==null&&m==null||$(e,t,f,p,r,m)}function Id(e){switch(e){case`css`:case`script`:case`font`:case`img`:case`image`:case`input`:case`link`:return!0;default:return!1}}function Ld(){if(typeof performance.getEntriesByType==`function`){for(var e=0,t=0,n=performance.getEntriesByType(`resource`),r=0;r<n.length;r++){var i=n[r],a=i.transferSize,o=i.initiatorType,s=i.duration;if(a&&s&&Id(o)){for(o=0,s=i.responseEnd,r+=1;r<n.length;r++){var c=n[r],l=c.startTime;if(l>s)break;var u=c.transferSize,d=c.initiatorType;u&&Id(d)&&(c=c.responseEnd,o+=u*(c<s?1:(s-l)/(c-l)))}if(--r,t+=8*(a+o)/(i.duration/1e3),e++,10<e)break}}if(0<e)return t/e/1e6}return navigator.connection&&(e=navigator.connection.downlink,typeof e==`number`)?e:5}var Rd=null,zd=null;function Bd(e){return e.nodeType===9?e:e.ownerDocument}function Vd(e){switch(e){case`http://www.w3.org/2000/svg`:return 1;case`http://www.w3.org/1998/Math/MathML`:return 2;default:return 0}}function Hd(e,t){if(e===0)switch(t){case`svg`:return 1;case`math`:return 2;default:return 0}return e===1&&t===`foreignObject`?0:e}function Ud(e,t){return e===`textarea`||e===`noscript`||typeof t.children==`string`||typeof t.children==`number`||typeof t.children==`bigint`||typeof t.dangerouslySetInnerHTML==`object`&&t.dangerouslySetInnerHTML!==null&&t.dangerouslySetInnerHTML.__html!=null}var Wd=null;function Gd(){var e=window.event;return e&&e.type===`popstate`?e!==Wd&&(Wd=e,!0):(Wd=null,!1)}var Kd=typeof setTimeout==`function`?setTimeout:void 0,qd=typeof clearTimeout==`function`?clearTimeout:void 0,Jd=typeof Promise==`function`?Promise:void 0,Yd=typeof queueMicrotask==`function`?queueMicrotask:Jd===void 0?Kd:function(e){return Jd.resolve(null).then(e).catch(Xd)};function Xd(e){setTimeout(function(){throw e})}function Zd(e){return e===`head`}function Qd(e,t){var n=t,r=0;do{var i=n.nextSibling;if(e.removeChild(n),i&&i.nodeType===8){if(n=i.data,n===`/$`||n===`/&`){if(r===0){e.removeChild(i),Np(t);return}r--}else if(n===`$`||n===`$?`||n===`$~`||n===`$!`||n===`&`)r++;else if(n===`html`)pf(e.ownerDocument.documentElement);else if(n===`head`){n=e.ownerDocument.head,pf(n);for(var a=n.firstChild;a;){var o=a.nextSibling,s=a.nodeName;a[xt]||s===`SCRIPT`||s===`STYLE`||s===`LINK`&&a.rel.toLowerCase()===`stylesheet`||n.removeChild(a),a=o}}else n===`body`&&pf(e.ownerDocument.body)}n=i}while(n);Np(t)}function $d(e,t){var n=e;e=0;do{var r=n.nextSibling;if(n.nodeType===1?t?(n._stashedDisplay=n.style.display,n.style.display=`none`):(n.style.display=n._stashedDisplay||``,n.getAttribute(`style`)===``&&n.removeAttribute(`style`)):n.nodeType===3&&(t?(n._stashedText=n.nodeValue,n.nodeValue=``):n.nodeValue=n._stashedText||``),r&&r.nodeType===8){if(n=r.data,n===`/$`){if(e===0)break;e--}else n!==`$`&&n!==`$?`&&n!==`$~`&&n!==`$!`||e++}n=r}while(n)}function ef(e){var t=e.firstChild;for(t&&t.nodeType===10&&(t=t.nextSibling);t;){var n=t;switch(t=t.nextSibling,n.nodeName){case`HTML`:case`HEAD`:case`BODY`:ef(n),St(n);continue;case`SCRIPT`:case`STYLE`:continue;case`LINK`:if(n.rel.toLowerCase()===`stylesheet`)continue}e.removeChild(n)}}function tf(e,t,n,r){for(;e.nodeType===1;){var i=n;if(e.nodeName.toLowerCase()!==t.toLowerCase()){if(!r&&(e.nodeName!==`INPUT`||e.type!==`hidden`))break}else if(!r){if(t===`input`&&e.type===`hidden`){var a=i.name==null?null:``+i.name;if(i.type===`hidden`&&e.getAttribute(`name`)===a)return e}else return e}else if(!e[xt])switch(t){case`meta`:if(!e.hasAttribute(`itemprop`))break;return e;case`link`:if(a=e.getAttribute(`rel`),a===`stylesheet`&&e.hasAttribute(`data-precedence`)||a!==i.rel||e.getAttribute(`href`)!==(i.href==null||i.href===``?null:i.href)||e.getAttribute(`crossorigin`)!==(i.crossOrigin==null?null:i.crossOrigin)||e.getAttribute(`title`)!==(i.title==null?null:i.title))break;return e;case`style`:if(e.hasAttribute(`data-precedence`))break;return e;case`script`:if(a=e.getAttribute(`src`),(a!==(i.src==null?null:i.src)||e.getAttribute(`type`)!==(i.type==null?null:i.type)||e.getAttribute(`crossorigin`)!==(i.crossOrigin==null?null:i.crossOrigin))&&a&&e.hasAttribute(`async`)&&!e.hasAttribute(`itemprop`))break;return e;default:return e}if(e=cf(e.nextSibling),e===null)break}return null}function nf(e,t,n){if(t===``)return null;for(;e.nodeType!==3;)if((e.nodeType!==1||e.nodeName!==`INPUT`||e.type!==`hidden`)&&!n||(e=cf(e.nextSibling),e===null))return null;return e}function rf(e,t){for(;e.nodeType!==8;)if((e.nodeType!==1||e.nodeName!==`INPUT`||e.type!==`hidden`)&&!t||(e=cf(e.nextSibling),e===null))return null;return e}function af(e){return e.data===`$?`||e.data===`$~`}function of(e){return e.data===`$!`||e.data===`$?`&&e.ownerDocument.readyState!==`loading`}function sf(e,t){var n=e.ownerDocument;if(e.data===`$~`)e._reactRetry=t;else if(e.data!==`$?`||n.readyState!==`loading`)t();else{var r=function(){t(),n.removeEventListener(`DOMContentLoaded`,r)};n.addEventListener(`DOMContentLoaded`,r),e._reactRetry=r}}function cf(e){for(;e!=null;e=e.nextSibling){var t=e.nodeType;if(t===1||t===3)break;if(t===8){if(t=e.data,t===`$`||t===`$!`||t===`$?`||t===`$~`||t===`&`||t===`F!`||t===`F`)break;if(t===`/$`||t===`/&`)return null}}return e}var lf=null;function uf(e){e=e.nextSibling;for(var t=0;e;){if(e.nodeType===8){var n=e.data;if(n===`/$`||n===`/&`){if(t===0)return cf(e.nextSibling);t--}else n!==`$`&&n!==`$!`&&n!==`$?`&&n!==`$~`&&n!==`&`||t++}e=e.nextSibling}return null}function df(e){e=e.previousSibling;for(var t=0;e;){if(e.nodeType===8){var n=e.data;if(n===`$`||n===`$!`||n===`$?`||n===`$~`||n===`&`){if(t===0)return e;t--}else n!==`/$`&&n!==`/&`||t++}e=e.previousSibling}return null}function ff(e,t,n){switch(t=Bd(n),e){case`html`:if(e=t.documentElement,!e)throw Error(i(452));return e;case`head`:if(e=t.head,!e)throw Error(i(453));return e;case`body`:if(e=t.body,!e)throw Error(i(454));return e;default:throw Error(i(451))}}function pf(e){for(var t=e.attributes;t.length;)e.removeAttributeNode(t[0]);St(e)}var mf=new Map,hf=new Set;function gf(e){return typeof e.getRootNode==`function`?e.getRootNode():e.nodeType===9?e:e.ownerDocument}var _f=E.d;E.d={f:vf,r:yf,D:Sf,C:Cf,L:wf,m:Tf,X:Df,S:Ef,M:Of};function vf(){var e=_f.f(),t=bu();return e||t}function yf(e){var t=wt(e);t!==null&&t.tag===5&&t.type===`form`?As(t):_f.r(e)}var bf=typeof document>`u`?null:document;function xf(e,t,n){var r=bf;if(r&&typeof t==`string`&&t){var i=Kt(t);i=`link[rel="`+e+`"][href="`+i+`"]`,typeof n==`string`&&(i+=`[crossorigin="`+n+`"]`),hf.has(i)||(hf.add(i),e={rel:e,crossOrigin:n,href:t},r.querySelector(i)===null&&(t=r.createElement(`link`),Pd(t,`link`,e),Dt(t),r.head.appendChild(t)))}}function Sf(e){_f.D(e),xf(`dns-prefetch`,e,null)}function Cf(e,t){_f.C(e,t),xf(`preconnect`,e,t)}function wf(e,t,n){_f.L(e,t,n);var r=bf;if(r&&e&&t){var i=`link[rel="preload"][as="`+Kt(t)+`"]`;t===`image`&&n&&n.imageSrcSet?(i+=`[imagesrcset="`+Kt(n.imageSrcSet)+`"]`,typeof n.imageSizes==`string`&&(i+=`[imagesizes="`+Kt(n.imageSizes)+`"]`)):i+=`[href="`+Kt(e)+`"]`;var a=i;switch(t){case`style`:a=Af(e);break;case`script`:a=Pf(e)}mf.has(a)||(e=h({rel:`preload`,href:t===`image`&&n&&n.imageSrcSet?void 0:e,as:t},n),mf.set(a,e),r.querySelector(i)!==null||t===`style`&&r.querySelector(jf(a))||t===`script`&&r.querySelector(Ff(a))||(t=r.createElement(`link`),Pd(t,`link`,e),Dt(t),r.head.appendChild(t)))}}function Tf(e,t){_f.m(e,t);var n=bf;if(n&&e){var r=t&&typeof t.as==`string`?t.as:`script`,i=`link[rel="modulepreload"][as="`+Kt(r)+`"][href="`+Kt(e)+`"]`,a=i;switch(r){case`audioworklet`:case`paintworklet`:case`serviceworker`:case`sharedworker`:case`worker`:case`script`:a=Pf(e)}if(!mf.has(a)&&(e=h({rel:`modulepreload`,href:e},t),mf.set(a,e),n.querySelector(i)===null)){switch(r){case`audioworklet`:case`paintworklet`:case`serviceworker`:case`sharedworker`:case`worker`:case`script`:if(n.querySelector(Ff(a)))return}r=n.createElement(`link`),Pd(r,`link`,e),Dt(r),n.head.appendChild(r)}}}function Ef(e,t,n){_f.S(e,t,n);var r=bf;if(r&&e){var i=Et(r).hoistableStyles,a=Af(e);t||=`default`;var o=i.get(a);if(!o){var s={loading:0,preload:null};if(o=r.querySelector(jf(a)))s.loading=5;else{e=h({rel:`stylesheet`,href:e,"data-precedence":t},n),(n=mf.get(a))&&Rf(e,n);var c=o=r.createElement(`link`);Dt(c),Pd(c,`link`,e),c._p=new Promise(function(e,t){c.onload=e,c.onerror=t}),c.addEventListener(`load`,function(){s.loading|=1}),c.addEventListener(`error`,function(){s.loading|=2}),s.loading|=4,Lf(o,t,r)}o={type:`stylesheet`,instance:o,count:1,state:s},i.set(a,o)}}}function Df(e,t){_f.X(e,t);var n=bf;if(n&&e){var r=Et(n).hoistableScripts,i=Pf(e),a=r.get(i);a||(a=n.querySelector(Ff(i)),a||(e=h({src:e,async:!0},t),(t=mf.get(i))&&zf(e,t),a=n.createElement(`script`),Dt(a),Pd(a,`link`,e),n.head.appendChild(a)),a={type:`script`,instance:a,count:1,state:null},r.set(i,a))}}function Of(e,t){_f.M(e,t);var n=bf;if(n&&e){var r=Et(n).hoistableScripts,i=Pf(e),a=r.get(i);a||(a=n.querySelector(Ff(i)),a||(e=h({src:e,async:!0,type:`module`},t),(t=mf.get(i))&&zf(e,t),a=n.createElement(`script`),Dt(a),Pd(a,`link`,e),n.head.appendChild(a)),a={type:`script`,instance:a,count:1,state:null},r.set(i,a))}}function kf(e,t,n,r){var a=(a=_e.current)?gf(a):null;if(!a)throw Error(i(446));switch(e){case`meta`:case`title`:return null;case`style`:return typeof n.precedence==`string`&&typeof n.href==`string`?(t=Af(n.href),n=Et(a).hoistableStyles,r=n.get(t),r||(r={type:`style`,instance:null,count:0,state:null},n.set(t,r)),r):{type:`void`,instance:null,count:0,state:null};case`link`:if(n.rel===`stylesheet`&&typeof n.href==`string`&&typeof n.precedence==`string`){e=Af(n.href);var o=Et(a).hoistableStyles,s=o.get(e);if(s||(a=a.ownerDocument||a,s={type:`stylesheet`,instance:null,count:0,state:{loading:0,preload:null}},o.set(e,s),(o=a.querySelector(jf(e)))&&!o._p&&(s.instance=o,s.state.loading=5),mf.has(e)||(n={rel:`preload`,as:`style`,href:n.href,crossOrigin:n.crossOrigin,integrity:n.integrity,media:n.media,hrefLang:n.hrefLang,referrerPolicy:n.referrerPolicy},mf.set(e,n),o||Nf(a,e,n,s.state))),t&&r===null)throw Error(i(528,``));return s}if(t&&r!==null)throw Error(i(529,``));return null;case`script`:return t=n.async,n=n.src,typeof n==`string`&&t&&typeof t!=`function`&&typeof t!=`symbol`?(t=Pf(n),n=Et(a).hoistableScripts,r=n.get(t),r||(r={type:`script`,instance:null,count:0,state:null},n.set(t,r)),r):{type:`void`,instance:null,count:0,state:null};default:throw Error(i(444,e))}}function Af(e){return`href="`+Kt(e)+`"`}function jf(e){return`link[rel="stylesheet"][`+e+`]`}function Mf(e){return h({},e,{"data-precedence":e.precedence,precedence:null})}function Nf(e,t,n,r){e.querySelector(`link[rel="preload"][as="style"][`+t+`]`)?r.loading=1:(t=e.createElement(`link`),r.preload=t,t.addEventListener(`load`,function(){return r.loading|=1}),t.addEventListener(`error`,function(){return r.loading|=2}),Pd(t,`link`,n),Dt(t),e.head.appendChild(t))}function Pf(e){return`[src="`+Kt(e)+`"]`}function Ff(e){return`script[async]`+e}function If(e,t,n){if(t.count++,t.instance===null)switch(t.type){case`style`:var r=e.querySelector(`style[data-href~="`+Kt(n.href)+`"]`);if(r)return t.instance=r,Dt(r),r;var a=h({},n,{"data-href":n.href,"data-precedence":n.precedence,href:null,precedence:null});return r=(e.ownerDocument||e).createElement(`style`),Dt(r),Pd(r,`style`,a),Lf(r,n.precedence,e),t.instance=r;case`stylesheet`:a=Af(n.href);var o=e.querySelector(jf(a));if(o)return t.state.loading|=4,t.instance=o,Dt(o),o;r=Mf(n),(a=mf.get(a))&&Rf(r,a),o=(e.ownerDocument||e).createElement(`link`),Dt(o);var s=o;return s._p=new Promise(function(e,t){s.onload=e,s.onerror=t}),Pd(o,`link`,r),t.state.loading|=4,Lf(o,n.precedence,e),t.instance=o;case`script`:return o=Pf(n.src),(a=e.querySelector(Ff(o)))?(t.instance=a,Dt(a),a):(r=n,(a=mf.get(o))&&(r=h({},n),zf(r,a)),e=e.ownerDocument||e,a=e.createElement(`script`),Dt(a),Pd(a,`link`,r),e.head.appendChild(a),t.instance=a);case`void`:return null;default:throw Error(i(443,t.type))}else t.type===`stylesheet`&&!(t.state.loading&4)&&(r=t.instance,t.state.loading|=4,Lf(r,n.precedence,e));return t.instance}function Lf(e,t,n){for(var r=n.querySelectorAll(`link[rel="stylesheet"][data-precedence],style[data-precedence]`),i=r.length?r[r.length-1]:null,a=i,o=0;o<r.length;o++){var s=r[o];if(s.dataset.precedence===t)a=s;else if(a!==i)break}a?a.parentNode.insertBefore(e,a.nextSibling):(t=n.nodeType===9?n.head:n,t.insertBefore(e,t.firstChild))}function Rf(e,t){e.crossOrigin??=t.crossOrigin,e.referrerPolicy??=t.referrerPolicy,e.title??=t.title}function zf(e,t){e.crossOrigin??=t.crossOrigin,e.referrerPolicy??=t.referrerPolicy,e.integrity??=t.integrity}var Bf=null;function Vf(e,t,n){if(Bf===null){var r=new Map,i=Bf=new Map;i.set(n,r)}else i=Bf,r=i.get(n),r||(r=new Map,i.set(n,r));if(r.has(e))return r;for(r.set(e,null),n=n.getElementsByTagName(e),i=0;i<n.length;i++){var a=n[i];if(!(a[xt]||a[mt]||e===`link`&&a.getAttribute(`rel`)===`stylesheet`)&&a.namespaceURI!==`http://www.w3.org/2000/svg`){var o=a.getAttribute(t)||``;o=e+o;var s=r.get(o);s?s.push(a):r.set(o,[a])}}return r}function Hf(e,t,n){e=e.ownerDocument||e,e.head.insertBefore(n,t===`title`?e.querySelector(`head > title`):null)}function Uf(e,t,n){if(n===1||t.itemProp!=null)return!1;switch(e){case`meta`:case`title`:return!0;case`style`:if(typeof t.precedence!=`string`||typeof t.href!=`string`||t.href===``)break;return!0;case`link`:if(typeof t.rel!=`string`||typeof t.href!=`string`||t.href===``||t.onLoad||t.onError)break;switch(t.rel){case`stylesheet`:return e=t.disabled,typeof t.precedence==`string`&&e==null;default:return!0}case`script`:if(t.async&&typeof t.async!=`function`&&typeof t.async!=`symbol`&&!t.onLoad&&!t.onError&&t.src&&typeof t.src==`string`)return!0}return!1}function Wf(e){return!(e.type===`stylesheet`&&!(e.state.loading&3))}function Gf(e,t,n,r){if(n.type===`stylesheet`&&(typeof r.media!=`string`||!1!==matchMedia(r.media).matches)&&!(n.state.loading&4)){if(n.instance===null){var i=Af(r.href),a=t.querySelector(jf(i));if(a){t=a._p,typeof t==`object`&&t&&typeof t.then==`function`&&(e.count++,e=Jf.bind(e),t.then(e,e)),n.state.loading|=4,n.instance=a,Dt(a);return}a=t.ownerDocument||t,r=Mf(r),(i=mf.get(i))&&Rf(r,i),a=a.createElement(`link`),Dt(a);var o=a;o._p=new Promise(function(e,t){o.onload=e,o.onerror=t}),Pd(a,`link`,r),n.instance=a}e.stylesheets===null&&(e.stylesheets=new Map),e.stylesheets.set(n,t),(t=n.state.preload)&&!(n.state.loading&3)&&(e.count++,n=Jf.bind(e),t.addEventListener(`load`,n),t.addEventListener(`error`,n))}}var Kf=0;function qf(e,t){return e.stylesheets&&e.count===0&&Xf(e,e.stylesheets),0<e.count||0<e.imgCount?function(n){var r=setTimeout(function(){if(e.stylesheets&&Xf(e,e.stylesheets),e.unsuspend){var t=e.unsuspend;e.unsuspend=null,t()}},6e4+t);0<e.imgBytes&&Kf===0&&(Kf=62500*Ld());var i=setTimeout(function(){if(e.waitingForImages=!1,e.count===0&&(e.stylesheets&&Xf(e,e.stylesheets),e.unsuspend)){var t=e.unsuspend;e.unsuspend=null,t()}},(e.imgBytes>Kf?50:800)+t);return e.unsuspend=n,function(){e.unsuspend=null,clearTimeout(r),clearTimeout(i)}}:null}function Jf(){if(this.count--,this.count===0&&(this.imgCount===0||!this.waitingForImages)){if(this.stylesheets)Xf(this,this.stylesheets);else if(this.unsuspend){var e=this.unsuspend;this.unsuspend=null,e()}}}var Yf=null;function Xf(e,t){e.stylesheets=null,e.unsuspend!==null&&(e.count++,Yf=new Map,t.forEach(Zf,e),Yf=null,Jf.call(e))}function Zf(e,t){if(!(t.state.loading&4)){var n=Yf.get(e);if(n)var r=n.get(null);else{n=new Map,Yf.set(e,n);for(var i=e.querySelectorAll(`link[data-precedence],style[data-precedence]`),a=0;a<i.length;a++){var o=i[a];(o.nodeName===`LINK`||o.getAttribute(`media`)!==`not all`)&&(n.set(o.dataset.precedence,o),r=o)}r&&n.set(null,r)}i=t.instance,o=i.getAttribute(`data-precedence`),a=n.get(o)||r,a===r&&n.set(null,i),n.set(o,i),this.count++,r=Jf.bind(this),i.addEventListener(`load`,r),i.addEventListener(`error`,r),a?a.parentNode.insertBefore(i,a.nextSibling):(e=e.nodeType===9?e.head:e,e.insertBefore(i,e.firstChild)),t.state.loading|=4}}var Qf={$$typeof:S,Provider:null,Consumer:null,_currentValue:de,_currentValue2:de,_threadCount:0};function $f(e,t,n,r,i,a,o,s,c){this.tag=1,this.containerInfo=e,this.pingCache=this.current=this.pendingChildren=null,this.timeoutHandle=-1,this.callbackNode=this.next=this.pendingContext=this.context=this.cancelPendingCommit=null,this.callbackPriority=0,this.expirationTimes=rt(-1),this.entangledLanes=this.shellSuspendCounter=this.errorRecoveryDisabledLanes=this.expiredLanes=this.warmLanes=this.pingedLanes=this.suspendedLanes=this.pendingLanes=0,this.entanglements=rt(0),this.hiddenUpdates=rt(null),this.identifierPrefix=r,this.onUncaughtError=i,this.onCaughtError=a,this.onRecoverableError=o,this.pooledCache=null,this.pooledCacheLanes=0,this.formState=c,this.incompleteTransitions=new Map}function ep(e,t,n,r,i,a,o,s,c,l,u,d){return e=new $f(e,t,n,o,c,l,u,d,s),t=1,!0===a&&(t|=24),a=gi(3,null,null,t),e.current=a,a.stateNode=e,t=ma(),t.refCount++,e.pooledCache=t,t.refCount++,a.memoizedState={element:r,isDehydrated:n,cache:t},qa(a),e}function tp(e){return e?(e=mi,e):mi}function np(e,t,n,r,i,a){i=tp(i),r.context===null?r.context=i:r.pendingContext=i,r=Ya(t),r.payload={element:n},a=a===void 0?null:a,a!==null&&(r.callback=a),n=Xa(e,r,t),n!==null&&(hu(n,e,t),Za(n,e,t))}function rp(e,t){if(e=e.memoizedState,e!==null&&e.dehydrated!==null){var n=e.retryLane;e.retryLane=n!==0&&n<t?n:t}}function ip(e,t){rp(e,t),(e=e.alternate)&&rp(e,t)}function ap(e){if(e.tag===13||e.tag===31){var t=di(e,67108864);t!==null&&hu(t,e,67108864),ip(e,67108864)}}function op(e){if(e.tag===13||e.tag===31){var t=pu();t=lt(t);var n=di(e,t);n!==null&&hu(n,e,t),ip(e,t)}}var sp=!0;function cp(e,t,n,r){var i=T.T;T.T=null;var a=E.p;try{E.p=2,up(e,t,n,r)}finally{E.p=a,T.T=i}}function lp(e,t,n,r){var i=T.T;T.T=null;var a=E.p;try{E.p=8,up(e,t,n,r)}finally{E.p=a,T.T=i}}function up(e,t,n,r){if(sp){var i=dp(r);if(i===null)wd(e,t,r,fp,n),Cp(e,r);else if(Tp(i,e,t,n,r))r.stopPropagation();else if(Cp(e,r),t&4&&-1<Sp.indexOf(e)){for(;i!==null;){var a=wt(i);if(a!==null)switch(a.tag){case 3:if(a=a.stateNode,a.current.memoizedState.isDehydrated){var o=$e(a.pendingLanes);if(o!==0){var s=a;for(s.pendingLanes|=2,s.entangledLanes|=2;o;){var c=1<<31-qe(o);s.entanglements[1]|=c,o&=~c}rd(a),!(W&6)&&(nu=Fe()+500,id(0,!1))}}break;case 31:case 13:s=di(a,2),s!==null&&hu(s,a,2),bu(),ip(a,2)}if(a=dp(r),a===null&&wd(e,t,r,fp,n),a===i)break;i=a}i!==null&&r.stopPropagation()}else wd(e,t,r,null,n)}}function dp(e){return e=un(e),pp(e)}var fp=null;function pp(e){if(fp=null,e=Ct(e),e!==null){var t=o(e);if(t===null)e=null;else{var n=t.tag;if(n===13){if(e=s(t),e!==null)return e;e=null}else if(n===31){if(e=c(t),e!==null)return e;e=null}else if(n===3){if(t.stateNode.current.memoizedState.isDehydrated)return t.tag===3?t.stateNode.containerInfo:null;e=null}else t!==e&&(e=null)}}return fp=e,null}function mp(e){switch(e){case`beforetoggle`:case`cancel`:case`click`:case`close`:case`contextmenu`:case`copy`:case`cut`:case`auxclick`:case`dblclick`:case`dragend`:case`dragstart`:case`drop`:case`focusin`:case`focusout`:case`input`:case`invalid`:case`keydown`:case`keypress`:case`keyup`:case`mousedown`:case`mouseup`:case`paste`:case`pause`:case`play`:case`pointercancel`:case`pointerdown`:case`pointerup`:case`ratechange`:case`reset`:case`resize`:case`seeked`:case`submit`:case`toggle`:case`touchcancel`:case`touchend`:case`touchstart`:case`volumechange`:case`change`:case`selectionchange`:case`textInput`:case`compositionstart`:case`compositionend`:case`compositionupdate`:case`beforeblur`:case`afterblur`:case`beforeinput`:case`blur`:case`fullscreenchange`:case`focus`:case`hashchange`:case`popstate`:case`select`:case`selectstart`:return 2;case`drag`:case`dragenter`:case`dragexit`:case`dragleave`:case`dragover`:case`mousemove`:case`mouseout`:case`mouseover`:case`pointermove`:case`pointerout`:case`pointerover`:case`scroll`:case`touchmove`:case`wheel`:case`mouseenter`:case`mouseleave`:case`pointerenter`:case`pointerleave`:return 8;case`message`:switch(Ie()){case Le:return 2;case Re:return 8;case ze:case Be:return 32;case Ve:return 268435456;default:return 32}default:return 32}}var hp=!1,gp=null,_p=null,vp=null,yp=new Map,bp=new Map,xp=[],Sp=`mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset`.split(` `);function Cp(e,t){switch(e){case`focusin`:case`focusout`:gp=null;break;case`dragenter`:case`dragleave`:_p=null;break;case`mouseover`:case`mouseout`:vp=null;break;case`pointerover`:case`pointerout`:yp.delete(t.pointerId);break;case`gotpointercapture`:case`lostpointercapture`:bp.delete(t.pointerId)}}function wp(e,t,n,r,i,a){return e===null||e.nativeEvent!==a?(e={blockedOn:t,domEventName:n,eventSystemFlags:r,nativeEvent:a,targetContainers:[i]},t!==null&&(t=wt(t),t!==null&&ap(t)),e):(e.eventSystemFlags|=r,t=e.targetContainers,i!==null&&t.indexOf(i)===-1&&t.push(i),e)}function Tp(e,t,n,r,i){switch(t){case`focusin`:return gp=wp(gp,e,t,n,r,i),!0;case`dragenter`:return _p=wp(_p,e,t,n,r,i),!0;case`mouseover`:return vp=wp(vp,e,t,n,r,i),!0;case`pointerover`:var a=i.pointerId;return yp.set(a,wp(yp.get(a)||null,e,t,n,r,i)),!0;case`gotpointercapture`:return a=i.pointerId,bp.set(a,wp(bp.get(a)||null,e,t,n,r,i)),!0}return!1}function Ep(e){var t=Ct(e.target);if(t!==null){var n=o(t);if(n!==null){if(t=n.tag,t===13){if(t=s(n),t!==null){e.blockedOn=t,ft(e.priority,function(){op(n)});return}}else if(t===31){if(t=c(n),t!==null){e.blockedOn=t,ft(e.priority,function(){op(n)});return}}else if(t===3&&n.stateNode.current.memoizedState.isDehydrated){e.blockedOn=n.tag===3?n.stateNode.containerInfo:null;return}}}e.blockedOn=null}function Dp(e){if(e.blockedOn!==null)return!1;for(var t=e.targetContainers;0<t.length;){var n=dp(e.nativeEvent);if(n===null){n=e.nativeEvent;var r=new n.constructor(n.type,n);ln=r,n.target.dispatchEvent(r),ln=null}else return t=wt(n),t!==null&&ap(t),e.blockedOn=n,!1;t.shift()}return!0}function Op(e,t,n){Dp(e)&&n.delete(t)}function kp(){hp=!1,gp!==null&&Dp(gp)&&(gp=null),_p!==null&&Dp(_p)&&(_p=null),vp!==null&&Dp(vp)&&(vp=null),yp.forEach(Op),bp.forEach(Op)}function Ap(e,n){e.blockedOn===n&&(e.blockedOn=null,hp||(hp=!0,t.unstable_scheduleCallback(t.unstable_NormalPriority,kp)))}var jp=null;function Mp(e){jp!==e&&(jp=e,t.unstable_scheduleCallback(t.unstable_NormalPriority,function(){jp===e&&(jp=null);for(var t=0;t<e.length;t+=3){var n=e[t],r=e[t+1],i=e[t+2];if(typeof r!=`function`){if(pp(r||n)===null)continue;break}var a=wt(n);a!==null&&(e.splice(t,3),t-=3,Os(a,{pending:!0,data:i,method:n.method,action:r},r,i))}}))}function Np(e){function t(t){return Ap(t,e)}gp!==null&&Ap(gp,e),_p!==null&&Ap(_p,e),vp!==null&&Ap(vp,e),yp.forEach(t),bp.forEach(t);for(var n=0;n<xp.length;n++){var r=xp[n];r.blockedOn===e&&(r.blockedOn=null)}for(;0<xp.length&&(n=xp[0],n.blockedOn===null);)Ep(n),n.blockedOn===null&&xp.shift();if(n=(e.ownerDocument||e).$$reactFormReplay,n!=null)for(r=0;r<n.length;r+=3){var i=n[r],a=n[r+1],o=i[ht]||null;if(typeof a==`function`)o||Mp(n);else if(o){var s=null;if(a&&a.hasAttribute(`formAction`)){if(i=a,o=a[ht]||null)s=o.formAction;else if(pp(i)!==null)continue}else s=o.action;typeof s==`function`?n[r+1]=s:(n.splice(r,3),r-=3),Mp(n)}}}function Pp(){function e(e){e.canIntercept&&e.info===`react-transition`&&e.intercept({handler:function(){return new Promise(function(e){return i=e})},focusReset:`manual`,scroll:`manual`})}function t(){i!==null&&(i(),i=null),r||setTimeout(n,20)}function n(){if(!r&&!navigation.transition){var e=navigation.currentEntry;e&&e.url!=null&&navigation.navigate(e.url,{state:e.getState(),info:`react-transition`,history:`replace`})}}if(typeof navigation==`object`){var r=!1,i=null;return navigation.addEventListener(`navigate`,e),navigation.addEventListener(`navigatesuccess`,t),navigation.addEventListener(`navigateerror`,t),setTimeout(n,100),function(){r=!0,navigation.removeEventListener(`navigate`,e),navigation.removeEventListener(`navigatesuccess`,t),navigation.removeEventListener(`navigateerror`,t),i!==null&&(i(),i=null)}}}function Fp(e){this._internalRoot=e}Ip.prototype.render=Fp.prototype.render=function(e){var t=this._internalRoot;if(t===null)throw Error(i(409));var n=t.current;np(n,pu(),e,t,null,null)},Ip.prototype.unmount=Fp.prototype.unmount=function(){var e=this._internalRoot;if(e!==null){this._internalRoot=null;var t=e.containerInfo;np(e.current,2,null,e,null,null),bu(),t[gt]=null}};function Ip(e){this._internalRoot=e}Ip.prototype.unstable_scheduleHydration=function(e){if(e){var t=dt();e={blockedOn:null,target:e,priority:t};for(var n=0;n<xp.length&&t!==0&&t<xp[n].priority;n++);xp.splice(n,0,e),n===0&&Ep(e)}};var Lp=n.version;if(Lp!==`19.2.8`)throw Error(i(527,Lp,`19.2.8`));E.findDOMNode=function(e){var t=e._reactInternals;if(t===void 0)throw typeof e.render==`function`?Error(i(188)):(e=Object.keys(e).join(`,`),Error(i(268,e)));return e=d(t),e=e===null?null:p(e),e=e===null?null:e.stateNode,e};var Rp={bundleType:0,version:`19.2.8`,rendererPackageName:`react-dom`,currentDispatcherRef:T,reconcilerVersion:`19.2.8`};if(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__<`u`){var zp=__REACT_DEVTOOLS_GLOBAL_HOOK__;if(!zp.isDisabled&&zp.supportsFiber)try{We=zp.inject(Rp),Ge=zp}catch{}}e.createRoot=function(e,t){if(!a(e))throw Error(i(299));var n=!1,r=``,o=Zs,s=Qs,c=$s;return t!=null&&(!0===t.unstable_strictMode&&(n=!0),t.identifierPrefix!==void 0&&(r=t.identifierPrefix),t.onUncaughtError!==void 0&&(o=t.onUncaughtError),t.onCaughtError!==void 0&&(s=t.onCaughtError),t.onRecoverableError!==void 0&&(c=t.onRecoverableError)),t=ep(e,1,!1,null,null,n,r,null,o,s,c,Pp),e[gt]=t.current,Sd(e),new Fp(t)}})),g=o(((e,t)=>{function n(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>`u`||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!=`function`))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(n)}catch(e){console.error(e)}}n(),t.exports=h()})),_=c(u(),1),v=g(),y=(...e)=>e.filter((e,t,n)=>!!e&&e.trim()!==``&&n.indexOf(e)===t).join(` `).trim(),b=e=>e.replace(/([a-z0-9])([A-Z])/g,`$1-$2`).toLowerCase(),x=e=>e.replace(/^([A-Z])|[\s-_]+(\w)/g,(e,t,n)=>n?n.toUpperCase():t.toLowerCase()),ee=e=>{let t=x(e);return t.charAt(0).toUpperCase()+t.slice(1)},S={xmlns:`http://www.w3.org/2000/svg`,width:24,height:24,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:2,strokeLinecap:`round`,strokeLinejoin:`round`},C=e=>{for(let t in e)if(t.startsWith(`aria-`)||t===`role`||t===`title`)return!0;return!1},te=(0,_.createContext)({}),ne=()=>(0,_.useContext)(te),re=(0,_.forwardRef)(({color:e,size:t,strokeWidth:n,absoluteStrokeWidth:r,className:i=``,children:a,iconNode:o,...s},c)=>{let{size:l=24,strokeWidth:u=2,absoluteStrokeWidth:d=!1,color:f=`currentColor`,className:p=``}=ne()??{},m=r??d?Number(n??u)*24/Number(t??l):n??u;return(0,_.createElement)(`svg`,{ref:c,...S,width:t??l??S.width,height:t??l??S.height,stroke:e??f,strokeWidth:m,className:y(`lucide`,p,i),...!a&&!C(s)&&{"aria-hidden":`true`},...s},[...o.map(([e,t])=>(0,_.createElement)(e,t)),...Array.isArray(a)?a:[a]])}),w=(e,t)=>{let n=(0,_.forwardRef)(({className:n,...r},i)=>(0,_.createElement)(re,{ref:i,iconNode:t,className:y(`lucide-${b(ee(e))}`,`lucide-${e}`,n),...r}));return n.displayName=ee(e),n},ie=w(`activity`,[[`path`,{d:`M22 12h-2.48a2 2 0 0 0-1.93 1.46l-2.35 8.36a.25.25 0 0 1-.48 0L9.24 2.18a.25.25 0 0 0-.48 0l-2.35 8.36A2 2 0 0 1 4.49 12H2`,key:`169zse`}]]),ae=w(`arrow-left`,[[`path`,{d:`m12 19-7-7 7-7`,key:`1l729n`}],[`path`,{d:`M19 12H5`,key:`x3x0zl`}]]),oe=w(`award`,[[`path`,{d:`m15.477 12.89 1.515 8.526a.5.5 0 0 1-.81.47l-3.58-2.687a1 1 0 0 0-1.197 0l-3.586 2.686a.5.5 0 0 1-.81-.469l1.514-8.526`,key:`1yiouv`}],[`circle`,{cx:`12`,cy:`8`,r:`6`,key:`1vp47v`}]]),se=w(`battery`,[[`path`,{d:`M 22 14 L 22 10`,key:`nqc4tb`}],[`rect`,{x:`2`,y:`6`,width:`16`,height:`12`,rx:`2`,key:`13zb55`}]]),ce=w(`bell`,[[`path`,{d:`M10.268 21a2 2 0 0 0 3.464 0`,key:`vwvbt9`}],[`path`,{d:`M3.262 15.326A1 1 0 0 0 4 17h16a1 1 0 0 0 .74-1.673C19.41 13.956 18 12.499 18 8A6 6 0 0 0 6 8c0 4.499-1.411 5.956-2.738 7.326`,key:`11g9vi`}]]),le=w(`briefcase`,[[`path`,{d:`M16 20V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16`,key:`jecpp`}],[`rect`,{width:`20`,height:`14`,x:`2`,y:`6`,rx:`2`,key:`i6l2r4`}]]),ue=w(`bug`,[[`path`,{d:`M12 20v-9`,key:`1qisl0`}],[`path`,{d:`M14 7a4 4 0 0 1 4 4v3a6 6 0 0 1-12 0v-3a4 4 0 0 1 4-4z`,key:`uouzyp`}],[`path`,{d:`M14.12 3.88 16 2`,key:`qol33r`}],[`path`,{d:`M21 21a4 4 0 0 0-3.81-4`,key:`1b0z45`}],[`path`,{d:`M21 5a4 4 0 0 1-3.55 3.97`,key:`5cxbf6`}],[`path`,{d:`M22 13h-4`,key:`1jl80f`}],[`path`,{d:`M3 21a4 4 0 0 1 3.81-4`,key:`1fjd4g`}],[`path`,{d:`M3 5a4 4 0 0 0 3.55 3.97`,key:`1d7oge`}],[`path`,{d:`M6 13H2`,key:`82j7cp`}],[`path`,{d:`m8 2 1.88 1.88`,key:`fmnt4t`}],[`path`,{d:`M9 7.13V6a3 3 0 1 1 6 0v1.13`,key:`1vgav8`}]]),T=w(`building`,[[`path`,{d:`M12 10h.01`,key:`1nrarc`}],[`path`,{d:`M12 14h.01`,key:`1etili`}],[`path`,{d:`M12 6h.01`,key:`1vi96p`}],[`path`,{d:`M16 10h.01`,key:`1m94wz`}],[`path`,{d:`M16 14h.01`,key:`1gbofw`}],[`path`,{d:`M16 6h.01`,key:`1x0f13`}],[`path`,{d:`M8 10h.01`,key:`19clt8`}],[`path`,{d:`M8 14h.01`,key:`6423bh`}],[`path`,{d:`M8 6h.01`,key:`1dz90k`}],[`path`,{d:`M9 22v-3a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v3`,key:`cabbwy`}],[`rect`,{x:`4`,y:`2`,width:`16`,height:`20`,rx:`2`,key:`1uxh74`}]]),E=w(`calendar-days`,[[`path`,{d:`M8 2v3`,key:`1ioesn`}],[`path`,{d:`M16 2v3`,key:`otl347`}],[`rect`,{x:`3`,y:`3`,width:`18`,height:`18`,rx:`2`,key:`h1oib`}],[`path`,{d:`M3 9h18`,key:`1pudct`}],[`path`,{d:`M8 13h.01`,key:`1sbv64`}],[`path`,{d:`M12 13h.01`,key:`y0uutt`}],[`path`,{d:`M16 13h.01`,key:`wip0gl`}],[`path`,{d:`M8 17h.01`,key:`p3bg7i`}],[`path`,{d:`M12 17h.01`,key:`p32p05`}],[`path`,{d:`M16 17h.01`,key:`ql8jdd`}]]),de=w(`calendar`,[[`path`,{d:`M8 2v3`,key:`1ioesn`}],[`path`,{d:`M16 2v3`,key:`otl347`}],[`rect`,{x:`3`,y:`3`,width:`18`,height:`18`,rx:`2`,key:`h1oib`}],[`path`,{d:`M3 9h18`,key:`1pudct`}]]),fe=w(`camera`,[[`path`,{d:`M13.997 4a2 2 0 0 1 1.76 1.05l.486.9A2 2 0 0 0 18.003 7H20a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h1.997a2 2 0 0 0 1.759-1.048l.489-.904A2 2 0 0 1 10.004 4z`,key:`18u6gg`}],[`circle`,{cx:`12`,cy:`13`,r:`3`,key:`1vg3eu`}]]),pe=w(`check`,[[`path`,{d:`M20 6 9 17l-5-5`,key:`1gmf2c`}]]),me=w(`chevron-right`,[[`path`,{d:`m9 18 6-6-6-6`,key:`mthhwq`}]]),D=w(`circle-alert`,[[`circle`,{cx:`12`,cy:`12`,r:`10`,key:`1mglay`}],[`line`,{x1:`12`,x2:`12`,y1:`8`,y2:`12`,key:`1pkeuh`}],[`line`,{x1:`12`,x2:`12.01`,y1:`16`,y2:`16`,key:`4dfq90`}]]),O=w(`circle-check`,[[`circle`,{cx:`12`,cy:`12`,r:`10`,key:`1mglay`}],[`path`,{d:`m9 12 2 2 4-4`,key:`dzmm74`}]]),he=w(`circle-plus`,[[`circle`,{cx:`12`,cy:`12`,r:`10`,key:`1mglay`}],[`path`,{d:`M8 12h8`,key:`1wcyev`}],[`path`,{d:`M12 8v8`,key:`napkw2`}]]),ge=w(`circle-x`,[[`circle`,{cx:`12`,cy:`12`,r:`10`,key:`1mglay`}],[`path`,{d:`m15 9-6 6`,key:`1uzhvr`}],[`path`,{d:`m9 9 6 6`,key:`z0biqf`}]]),_e=w(`clock`,[[`circle`,{cx:`12`,cy:`12`,r:`10`,key:`1mglay`}],[`path`,{d:`M12 6v6l4 2`,key:`mmk7yg`}]]),ve=w(`database`,[[`ellipse`,{cx:`12`,cy:`5`,rx:`9`,ry:`3`,key:`msslwz`}],[`path`,{d:`M3 5V19A9 3 0 0 0 21 19V5`,key:`1wlel7`}],[`path`,{d:`M3 12A9 3 0 0 0 21 12`,key:`mv7ke4`}]]),ye=w(`dollar-sign`,[[`line`,{x1:`12`,x2:`12`,y1:`2`,y2:`22`,key:`7eqyqh`}],[`path`,{d:`M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6`,key:`1b0p4s`}]]),be=w(`droplet`,[[`path`,{d:`M12 22a7 7 0 0 0 7-7c0-2-1-3.9-3-5.5s-3.5-4-4-6.5c-.5 2.5-2 4.9-4 6.5C6 11.1 5 13 5 15a7 7 0 0 0 7 7z`,key:`c7niix`}]]),xe=w(`eye-off`,[[`path`,{d:`M10.733 5.076a10.744 10.744 0 0 1 11.205 6.575 1 1 0 0 1 0 .696 10.747 10.747 0 0 1-1.444 2.49`,key:`ct8e1f`}],[`path`,{d:`M14.084 14.158a3 3 0 0 1-4.242-4.242`,key:`151rxh`}],[`path`,{d:`M17.479 17.499a10.75 10.75 0 0 1-15.417-5.151 1 1 0 0 1 0-.696 10.75 10.75 0 0 1 4.446-5.143`,key:`13bj9a`}],[`path`,{d:`m2 2 20 20`,key:`1ooewy`}]]),Se=w(`eye`,[[`path`,{d:`M2.062 12.348a1 1 0 0 1 0-.696 10.75 10.75 0 0 1 19.876 0 1 1 0 0 1 0 .696 10.75 10.75 0 0 1-19.876 0`,key:`1nclc0`}],[`circle`,{cx:`12`,cy:`12`,r:`3`,key:`1v7zrd`}]]),Ce=w(`funnel`,[[`path`,{d:`M10 20a1 1 0 0 0 .553.895l2 1A1 1 0 0 0 14 21v-7a2 2 0 0 1 .517-1.341L21.74 4.67A1 1 0 0 0 21 3H3a1 1 0 0 0-.742 1.67l7.225 7.989A2 2 0 0 1 10 14z`,key:`sc7q7i`}]]),we=w(`heart`,[[`path`,{d:`M2 9.5a5.5 5.5 0 0 1 9.591-3.676.56.56 0 0 0 .818 0A5.49 5.49 0 0 1 22 9.5c0 2.29-1.5 4-3 5.5l-5.492 5.313a2 2 0 0 1-3 .019L5 15c-1.5-1.5-3-3.2-3-5.5`,key:`mvr1a0`}]]),Te=w(`house`,[[`path`,{d:`M15 21v-8a1 1 0 0 0-1-1h-4a1 1 0 0 0-1 1v8`,key:`5wwlr5`}],[`path`,{d:`M3 10a2 2 0 0 1 .709-1.528l7-6a2 2 0 0 1 2.582 0l7 6A2 2 0 0 1 21 10v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z`,key:`r6nss1`}]]),Ee=w(`lock`,[[`rect`,{width:`18`,height:`11`,x:`3`,y:`11`,rx:`2`,ry:`2`,key:`1w4ew1`}],[`path`,{d:`M7 11V7a5 5 0 0 1 10 0v4`,key:`fwvmzm`}]]),De=w(`log-out`,[[`path`,{d:`m16 17 5-5-5-5`,key:`1bji2h`}],[`path`,{d:`M21 12H9`,key:`dn1m92`}],[`path`,{d:`M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4`,key:`1uf3rs`}]]),Oe=w(`mail`,[[`path`,{d:`m22 7-8.991 5.727a2 2 0 0 1-2.009 0L2 7`,key:`132q7q`}],[`rect`,{x:`2`,y:`4`,width:`20`,height:`16`,rx:`2`,key:`izxlao`}]]),ke=w(`map-pin`,[[`path`,{d:`M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0`,key:`1r0f0z`}],[`circle`,{cx:`12`,cy:`10`,r:`3`,key:`ilqhr7`}]]),Ae=w(`monitor`,[[`rect`,{width:`20`,height:`14`,x:`2`,y:`3`,rx:`2`,key:`48i651`}],[`line`,{x1:`8`,x2:`16`,y1:`21`,y2:`21`,key:`1svkeh`}],[`line`,{x1:`12`,x2:`12`,y1:`17`,y2:`21`,key:`vw1qmm`}]]),je=w(`phone`,[[`path`,{d:`M13.832 16.568a1 1 0 0 0 1.213-.303l.355-.465A2 2 0 0 1 17 15h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2A18 18 0 0 1 2 4a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v3a2 2 0 0 1-.8 1.6l-.468.351a1 1 0 0 0-.292 1.233 14 14 0 0 0 6.392 6.384`,key:`9njp5v`}]]),Me=w(`plus`,[[`path`,{d:`M5 12h14`,key:`1ays0h`}],[`path`,{d:`M12 5v14`,key:`s699le`}]]),Ne=w(`search`,[[`path`,{d:`m21 21-4.34-4.34`,key:`14j7rj`}],[`circle`,{cx:`11`,cy:`11`,r:`8`,key:`4ej97u`}]]),Pe=w(`shield-alert`,[[`path`,{d:`M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z`,key:`oel41y`}],[`path`,{d:`M12 8v4`,key:`1got3b`}],[`path`,{d:`M12 16h.01`,key:`1drbdi`}]]),Fe=w(`shield-check`,[[`path`,{d:`M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z`,key:`oel41y`}],[`path`,{d:`m9 12 2 2 4-4`,key:`dzmm74`}]]),Ie=w(`signal`,[[`path`,{d:`M2 20h.01`,key:`4haj6o`}],[`path`,{d:`M7 20v-4`,key:`j294jx`}],[`path`,{d:`M12 20v-8`,key:`i3yub9`}],[`path`,{d:`M17 20V8`,key:`1tkaf5`}],[`path`,{d:`M22 4v16`,key:`sih9yq`}]]),Le=w(`smartphone`,[[`rect`,{width:`14`,height:`20`,x:`5`,y:`2`,rx:`2`,ry:`2`,key:`1yt0o3`}],[`path`,{d:`M12 18h.01`,key:`mhygvu`}]]),Re=w(`star`,[[`path`,{d:`M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.16l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l.882 5.14a.53.53 0 0 1-.771.56l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.56l.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z`,key:`r04s7s`}]]),ze=w(`stethoscope`,[[`path`,{d:`M11 2v2`,key:`1539x4`}],[`path`,{d:`M5 2v2`,key:`1yf1q8`}],[`path`,{d:`M5 3H4a2 2 0 0 0-2 2v4a6 6 0 0 0 12 0V5a2 2 0 0 0-2-2h-1`,key:`rb5t3r`}],[`path`,{d:`M8 15a6 6 0 0 0 12 0v-3`,key:`x18d4x`}],[`circle`,{cx:`20`,cy:`10`,r:`2`,key:`ts1r5v`}]]),Be=w(`thermometer`,[[`path`,{d:`M14 4v10.54a4 4 0 1 1-4 0V4a2 2 0 0 1 4 0Z`,key:`17jzev`}]]),Ve=w(`upload`,[[`path`,{d:`M12 3v12`,key:`1x0j5s`}],[`path`,{d:`m17 8-5-5-5 5`,key:`7q97r8`}],[`path`,{d:`M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4`,key:`ih7n3h`}]]),He=w(`user`,[[`path`,{d:`M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2`,key:`975kel`}],[`circle`,{cx:`12`,cy:`7`,r:`4`,key:`17ys0d`}]]),Ue=w(`users`,[[`path`,{d:`M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2`,key:`1yyitq`}],[`path`,{d:`M16 3.128a4 4 0 0 1 0 7.744`,key:`16gr8j`}],[`path`,{d:`M22 21v-2a4 4 0 0 0-3-3.87`,key:`kshegd`}],[`circle`,{cx:`9`,cy:`7`,r:`4`,key:`nufk8`}]]),We=w(`video`,[[`path`,{d:`m16 13 5.223 3.482a.5.5 0 0 0 .777-.416V7.87a.5.5 0 0 0-.752-.432L16 10.5`,key:`ftymec`}],[`rect`,{x:`2`,y:`6`,width:`14`,height:`12`,rx:`2`,key:`158x01`}]]),Ge=w(`wallet`,[[`path`,{d:`M19 7V4a1 1 0 0 0-1-1H5a2 2 0 0 0 0 4h15a1 1 0 0 1 1 1v4h-3a2 2 0 0 0 0 4h3a1 1 0 0 0 1-1v-2a1 1 0 0 0-1-1`,key:`18etb6`}],[`path`,{d:`M3 5v14a2 2 0 0 0 2 2h15a1 1 0 0 0 1-1v-4`,key:`xoc0q4`}]]),Ke=w(`wifi`,[[`path`,{d:`M12 20h.01`,key:`zekei9`}],[`path`,{d:`M2 8.82a15 15 0 0 1 20 0`,key:`dnpr2z`}],[`path`,{d:`M5 12.859a10 10 0 0 1 14 0`,key:`1x1e6c`}],[`path`,{d:`M8.5 16.429a5 5 0 0 1 7 0`,key:`1bycff`}]]),qe=w(`wind`,[[`path`,{d:`M12.8 19.6A2 2 0 1 0 14 16H2`,key:`148xed`}],[`path`,{d:`M17.5 8a2.5 2.5 0 1 1 2 4H2`,key:`1u4tom`}],[`path`,{d:`M9.8 4.4A2 2 0 1 1 11 8H2`,key:`75valh`}]]),Je=w(`x`,[[`path`,{d:`M18 6 6 18`,key:`1bl5f8`}],[`path`,{d:`m6 6 12 12`,key:`d8bk6v`}]]),Ye=o((e=>{var t=Symbol.for(`react.transitional.element`),n=Symbol.for(`react.fragment`);function r(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.Fragment=n,e.jsx=r,e.jsxs=r})),k=o(((e,t)=>{t.exports=Ye()}))();function Xe({children:e}){let[t,n]=(0,_.useState)(!0),[r,i]=(0,_.useState)(!1);return(0,_.useEffect)(()=>{let e=()=>{window.innerWidth<=768||window.isNative||window.Capacitor?.isNativePlatform()?i(!0):i(!1)};return e(),window.addEventListener(`resize`,e),()=>window.removeEventListener(`resize`,e)},[]),r?(0,k.jsxs)(`div`,{className:`native-mobile-app-container`,children:[e,(0,k.jsx)(`style`,{children:`
        ...
        `})]}):(0,k.jsxs)(`div`,{className:`app-viewport-wrapper ${t?`is-framed-mode`:`full-screen-mode`}`,children:[(0,k.jsxs)(`div`,{className:`view-mode-toggle`,children:[(0,k.jsx)(`span`,{className:`toggle-title`,children:`Medic Mobile App`}),(0,k.jsxs)(`button`,{className:`toggle-mode-btn`,onClick:()=>n(!t),title:`Toggle Mobile Bezel / Full Width`,children:[t?(0,k.jsx)(Ae,{size:15}):(0,k.jsx)(Le,{size:15}),(0,k.jsx)(`span`,{children:t?`Full Width`:`Phone Frame`})]})]}),(0,k.jsxs)(`div`,{className:`phone-device-shell`,children:[t&&(0,k.jsxs)(`div`,{className:`phone-status-bar`,children:[(0,k.jsx)(`span`,{className:`status-time`,children:`9:41`}),(0,k.jsx)(`div`,{className:`phone-notch`,children:(0,k.jsx)(`div`,{className:`camera-lens`})}),(0,k.jsxs)(`div`,{className:`status-icons`,children:[(0,k.jsx)(Ie,{size:12}),(0,k.jsx)(Ke,{size:12}),(0,k.jsx)(se,{size:13})]})]}),(0,k.jsx)(`div`,{className:`phone-screen-content`,children:e})]}),(0,k.jsx)(`style`,{children:`
      ...
      `})]})}function Ze({variant:e=`splash`}){let t=(0,_.useRef)(null);return(0,_.useEffect)(()=>{let n=t.current;if(!n)return;let r=n.getContext(`2d`),i,a=()=>{n.width=n.parentElement?.clientWidth||window.innerWidth,n.height=n.parentElement?.clientHeight||window.innerHeight};a(),window.addEventListener(`resize`,a);let o=Array.from({length:25},()=>({x:Math.random()*n.width,y:Math.random()*n.height,radius:Math.random()*3+1.5,speedX:(Math.random()-.5)*.6,speedY:(Math.random()-.5)*.6,alpha:Math.random()*.5+.2})),s=0,c=()=>{r.clearRect(0,0,n.width,n.height),s+=.015,r.lineWidth=1.5,r.beginPath();for(let e=0;e<n.width;e+=5){let t=Math.sin(e*.008+s)*25+Math.cos(e*.004+s*.5)*15+n.height*.45;e===0?r.moveTo(e,t):r.lineTo(e,t)}r.strokeStyle=e===`splash`?`rgba(255, 255, 255, 0.15)`:`rgba(11, 93, 113, 0.12)`,r.stroke(),r.beginPath();for(let e=0;e<n.width;e+=5){let t=Math.cos(e*.01-s*.8)*30+Math.sin(e*.005+s)*20+n.height*.55;e===0?r.moveTo(e,t):r.lineTo(e,t)}if(r.strokeStyle=e===`splash`?`rgba(56, 189, 248, 0.2)`:`rgba(2, 132, 199, 0.14)`,r.stroke(),e===`splash`||e===`onboarding`){r.beginPath();let t=n.height*.68;for(let e=0;e<n.width;e+=3){let i=0,a=(e+s*120)%n.width;a>100&&a<120?i=-18:a>=120&&a<135?i=28:a>=135&&a<150?i=-35:a>=150&&a<165&&(i=15);let o=t+i;e===0?r.moveTo(e,o):r.lineTo(e,o)}r.strokeStyle=e===`splash`?`rgba(255, 255, 255, 0.25)`:`rgba(11, 93, 113, 0.18)`,r.stroke()}o.forEach(t=>{t.x+=t.speedX,t.y+=t.speedY,(t.x<0||t.x>n.width)&&(t.speedX*=-1),(t.y<0||t.y>n.height)&&(t.speedY*=-1),r.beginPath(),r.arc(t.x,t.y,t.radius,0,Math.PI*2),r.fillStyle=e===`splash`?`rgba(255, 255, 255, ${t.alpha})`:`rgba(11, 93, 113, ${t.alpha*.6})`,r.fill()}),i=requestAnimationFrame(c)};return c(),()=>{window.removeEventListener(`resize`,a),cancelAnimationFrame(i)}},[e]),(0,k.jsxs)(`div`,{className:`animated-clip-wrapper`,children:[(0,k.jsx)(`canvas`,{ref:t,className:`background-canvas`}),(0,k.jsxs)(`div`,{className:`floating-icons-container`,children:[(0,k.jsx)(`div`,{className:`float-icon float-1`,children:(0,k.jsx)(we,{size:20,color:e===`splash`?`#38bdf8`:`#0b5d71`})}),(0,k.jsx)(`div`,{className:`float-icon float-2`,children:(0,k.jsx)(ie,{size:22,color:e===`splash`?`#ffffff`:`#0284c7`})}),(0,k.jsx)(`div`,{className:`float-icon float-3`,children:(0,k.jsx)(be,{size:18,color:e===`splash`?`#38bdf8`:`#0d9488`})}),(0,k.jsx)(`div`,{className:`float-icon float-4`,children:(0,k.jsx)(Me,{size:24,color:e===`splash`?`#ffffff`:`#10b981`})}),(0,k.jsx)(`div`,{className:`float-icon float-5`,children:(0,k.jsx)(qe,{size:20,color:e===`splash`?`#38bdf8`:`#e11d48`})})]}),(0,k.jsx)(`style`,{children:`
      ...
      `})]})}function Qe({onFinish:e}){return(0,_.useEffect)(()=>{let t=setTimeout(()=>{e()},2800);return()=>clearTimeout(t)},[e]),(0,k.jsxs)(`div`,{className:`splash-screen`,children:[(0,k.jsx)(Ze,{variant:`splash`}),(0,k.jsxs)(`div`,{className:`wave-container`,children:[(0,k.jsx)(`div`,{className:`wave wave-1`}),(0,k.jsx)(`div`,{className:`wave wave-2`}),(0,k.jsx)(`div`,{className:`wave wave-3`})]}),(0,k.jsxs)(`div`,{className:`splash-content`,children:[(0,k.jsx)(`div`,{className:`splash-logo-circle`,children:(0,k.jsx)(`div`,{className:`inner-logo-badge`,children:(0,k.jsxs)(`svg`,{viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`1.8`,className:`medic-logo-icon`,children:[(0,k.jsx)(`path`,{d:`M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z`}),(0,k.jsx)(`path`,{d:`M12 7v6M9 10h6`,stroke:`#0b5d71`,strokeWidth:`2.5`,strokeLinecap:`round`})]})})}),(0,k.jsx)(`h1`,{className:`splash-title`,children:`Medic`}),(0,k.jsx)(`p`,{className:`splash-subtitle`,children:`Your Trusted Healthcare Companion`}),(0,k.jsx)(`div`,{className:`running-loader-bar`,children:(0,k.jsx)(`div`,{className:`running-fill`})})]}),(0,k.jsx)(`style`,{children:`
        .splash-screen {
          position: absolute;
          inset: 0;
      ...
      `})]})}function $e({onSignIn:e,onCreateAccount:t}){return(0,k.jsxs)(`div`,{className:`onboarding-screen animate-fade-in`,children:[(0,k.jsx)(Ze,{variant:`onboarding`}),(0,k.jsx)(`div`,{className:`onboarding-visual`,children:(0,k.jsxs)(`div`,{className:`orbit-container`,children:[(0,k.jsx)(`div`,{className:`orbit-ring orbit-ring-1`}),(0,k.jsx)(`div`,{className:`orbit-ring orbit-ring-2`}),(0,k.jsx)(`div`,{className:`center-medic-badge`,children:(0,k.jsxs)(`svg`,{viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`1.8`,className:`medic-center-icon`,children:[(0,k.jsx)(`path`,{d:`M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z`}),(0,k.jsx)(`path`,{d:`M12 7v6M9 10h6`,stroke:`#0b5d71`,strokeWidth:`2.5`,strokeLinecap:`round`})]})}),(0,k.jsx)(`div`,{className:`orbiting-nodes`,children:[{img:`/assets/doc_real_1.jpg`,label:`Pediatrician`},{img:`/assets/doc_real_2.jpg`,label:`Cardiologist`},{img:`/assets/doc_real_3.jpg`,label:`Dermatologist`},{img:`/assets/doc_real_4.jpg`,label:`Neurologist`}].map((e,t)=>(0,k.jsx)(`div`,{className:`orbit-node node-${t}`,children:(0,k.jsx)(`img`,{src:e.img,alt:e.label,className:`node-avatar`})},t))})]})}),(0,k.jsxs)(`div`,{className:`onboarding-body`,children:[(0,k.jsx)(`h2`,{className:`welcome-title`,children:`Welcome to Medic`}),(0,k.jsx)(`p`,{className:`welcome-desc`,children:`Your trusted healthcare companion — find doctors, book visits, and stay on top of your care.`}),(0,k.jsxs)(`div`,{className:`onboarding-actions`,children:[(0,k.jsx)(`button`,{className:`btn-primary`,onClick:e,children:`Sign In`}),(0,k.jsx)(`button`,{className:`btn-outline`,onClick:t,children:`Create Account`})]})]}),(0,k.jsx)(`style`,{children:`
        .onboarding-screen {
          position: absolute;
          inset: 0;
      ...
      `})]})}var et;(function(e){e.Any=`any`,e.ApNortheast1=`ap-northeast-1`,e.ApNortheast2=`ap-northeast-2`,e.ApSouth1=`ap-south-1`,e.ApSoutheast1=`ap-southeast-1`,e.ApSoutheast2=`ap-southeast-2`,e.CaCentral1=`ca-central-1`,e.EuCentral1=`eu-central-1`,e.EuWest1=`eu-west-1`,e.EuWest2=`eu-west-2`,e.EuWest3=`eu-west-3`,e.SaEast1=`sa-east-1`,e.UsEast1=`us-east-1`,e.UsWest1=`us-west-1`,e.UsWest2=`us-west-2`})(et||={});var A;(function(e){e.abstime=`abstime`,e.bool=`bool`,e.date=`date`,e.daterange=`daterange`,e.float4=`float4`,e.float8=`float8`,e.int2=`int2`,e.int4=`int4`,e.int4range=`int4range`,e.int8=`int8`,e.int8range=`int8range`,e.json=`json`,e.jsonb=`jsonb`,e.money=`money`,e.numeric=`numeric`,e.oid=`oid`,e.reltime=`reltime`,e.text=`text`,e.time=`time`,e.timestamp=`timestamp`,e.timestamptz=`timestamptz`,e.timetz=`timetz`,e.tsrange=`tsrange`,e.tstzrange=`tstzrange`})(A||={});var tt=(e,t)=>{if(e.charAt(0)===`_`)return ot(t,e.slice(1,e.length));switch(e){case A.bool:return rt(t);case A.float4:case A.float8:case A.int2:case A.int4:case A.int8:case A.numeric:case A.oid:return it(t);case A.json:case A.jsonb:return at(t);case A.timestamp:return st(t);case A.abstime:case A.date:case A.daterange:case A.int4range:case A.int8range:case A.money:case A.reltime:case A.text:case A.time:case A.timestamptz:case A.timetz:case A.tsrange:case A.tstzrange:return nt(t);default:return nt(t)}},nt=e=>e,rt=e=>{switch(e){case`t`:return!0;case`f`:return!1;default:return e}},it=e=>{if(typeof e==`string`){let t=parseFloat(e);if(!Number.isNaN(t))return t}return e},at=e=>{if(typeof e==`string`)try{return JSON.parse(e)}catch{return e}return e},ot=(e,t)=>{if(typeof e!=`string`)return e;let n=e.length-1,r=e[n];if(e[0]===`{`&&r===`}`){let r,i=e.slice(1,n);try{r=JSON.parse(`[`+i+`]`)}catch{r=i?i.split(`,`):[]}return r.map(e=>tt(t,e))}return e},st=e=>typeof e==`string`?e.replace(` `,`T`):e,ct;(function(e){e.SYNC=`sync`,e.JOIN=`join`,e.LEAVE=`leave`})(ct||={});var lt;(function(e){e.ALL=`*`,e.INSERT=`INSERT`,e.UPDATE=`UPDATE`,e.DELETE=`DELETE`})(lt||={});var ut;(function(e){e.BROADCAST=`broadcast`,e.PRESENCE=`presence`,e.POSTGRES_CHANGES=`postgres_changes`,e.SYSTEM=`system`})(ut||={});var dt;(function(e){e.SUBSCRIBED=`SUBSCRIBED`,e.TIMED_OUT=`TIMED_OUT`,e.CLOSED=`CLOSED`,e.CHANNEL_ERROR=`CHANNEL_ERROR`})(dt||={});function ft(e){"@babel/helpers - typeof";return ft=typeof Symbol==`function`&&typeof Symbol.iterator==`symbol`?function(e){return typeof e}:function(e){return e&&typeof Symbol==`function`&&e.constructor===Symbol&&e!==Symbol.prototype?`symbol`:typeof e},ft(e)}function pt(e,t){if(ft(e)!=`object`||!e)return e;var n=e[Symbol.toPrimitive];if(n!==void 0){var r=n.call(e,t||`default`);if(ft(r)!=`object`)return r;throw TypeError(`@@toPrimitive must return a primitive value.`)}return(t===`string`?String:Number)(e)}function mt(e){var t=pt(e,`string`);return ft(t)==`symbol`?t:t+``}function ht(e,t,n){return(t=mt(t))in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function gt(e,t){var n=Object.keys(e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e);t&&(r=r.filter(function(t){return Object.getOwnPropertyDescriptor(e,t).enumerable})),n.push.apply(n,r)}return n}function _t(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]==null?{}:arguments[t];t%2?gt(Object(n),!0).forEach(function(t){ht(e,t,n[t])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(n)):gt(Object(n)).forEach(function(t){Object.defineProperty(e,t,Object.getOwnPropertyDescriptor(n,t))})}return e}var vt=class extends Error{constructor(e,t=`storage`,n,r){super(e),this.__isStorageError=!0,this.namespace=t,this.name=t===`vectors`?`StorageVectorsError`:`StorageError`,this.status=n,this.statusCode=r}toJSON(){return{name:this.name,message:this.message,status:this.status,statusCode:this.statusCode}}},yt=class extends vt{constructor(e,t,n,r=`storage`,i){super(e,r,t,n),this.name=r===`vectors`?`StorageVectorsApiError`:`StorageApiError`,this.status=t,this.statusCode=n,this.code=i}toJSON(){return _t(_t({},super.toJSON()),{},{code:this.code})}},bt=class extends vt{constructor(e,t,n=`storage`){super(e,n),this.name=n===`vectors`?`StorageVectorsUnknownError`:`StorageUnknownError`,this.originalError=t}};function xt(e,t,n){let r=_t({},e),i=t.toLowerCase();for(let e of Object.keys(r))e.toLowerCase()===i&&delete r[e];return r[i]=n,r}var St=e=>{if(typeof e!=`object`||!e)return!1;let t=Object.getPrototypeOf(e);return(t===null||t===Object.prototype||Object.getPrototypeOf(t)===null)&&!(Symbol.toStringTag in e)&&!(Symbol.iterator in e)},Ct=e=>{if(typeof e==`object`&&e){let t=e;if(typeof t.msg==`string`)return t.msg;if(typeof t.message==`string`)return t.message;if(typeof t.error_description==`string`)return t.error_description;if(typeof t.error==`string`)return t.error;if(typeof t.error==`object`&&t.error!==null){let e=t.error;if(typeof e.message==`string`)return e.message}}return JSON.stringify(e)},wt=async(e,t,n,r)=>{if(typeof e==`object`&&e&&`json`in e&&typeof e.json==`function`){let n=e,i=parseInt(String(n.status),10);Number.isFinite(i)||(i=500),n.json().then(e=>{let n=e?.statusCode||e?.code||i+``;t(new yt(Ct(e),i,n,r,e?.code))}).catch(()=>{let e=i+``;t(new yt(n.statusText||`HTTP ${i} error`,i,e,r))})}else t(new bt(Ct(e),e,r))},Tt=(e,t,n,r)=>{let i={method:e,headers:t?.headers||{}};if(e===`GET`||e===`HEAD`||!r)return _t(_t({},i),n);if(St(r)){let e=t?.headers||{},n;for(let[t,r]of Object.entries(e))t.toLowerCase()===`content-type`&&(n=r);i.headers=xt(e,`Content-Type`,n??`application/json`),i.body=JSON.stringify(r)}else i.body=r;return t?.duplex&&(i.duplex=t.duplex),_t(_t({},i),n)};async function Et(e,t,n,r,i,a,o){return new Promise((s,c)=>{e(n,Tt(t,r,i,a)).then(e=>{if(!e.ok)throw e;if(r?.noResolveJson)return e;if(o===`vectors`){let t=e.headers.get(`content-type`);if(e.headers.get(`content-length`)===`0`||e.status===204||!t||!t.includes(`application/json`))return{}}return e.json()}).then(e=>s(e)).catch(e=>wt(e,c,r,o))})}function Dt(e=`storage`){return{get:async(t,n,r,i)=>Et(t,`GET`,n,r,i,void 0,e),post:async(t,n,r,i,a)=>Et(t,`POST`,n,i,a,r,e),put:async(t,n,r,i,a)=>Et(t,`PUT`,n,i,a,r,e),head:async(t,n,r,i)=>Et(t,`HEAD`,n,_t(_t({},r),{},{noResolveJson:!0}),i,void 0,e),remove:async(t,n,r,i,a)=>Et(t,`DELETE`,n,i,a,r,e)}}var{get:Ot,post:kt,put:At,head:jt,remove:Mt}=Dt(`storage`),Nt=`2.112.3`,Pt=3e4;3*Pt,2*Pt,`${Nt}`;var Ft=`ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_`.split(``),It=` 	
\r=`.split(``);(()=>{let e=Array(128);for(let t=0;t<e.length;t+=1)e[t]=-1;for(let t=0;t<It.length;t+=1)e[It[t].charCodeAt(0)]=-2;for(let t=0;t<Ft.length;t+=1)e[Ft[t].charCodeAt(0)]=t;return e})();var Lt=()=>typeof window<`u`&&typeof document<`u`,Rt={tested:!1,writable:!1};globalThis&&(()=>{if(!Lt())return!1;try{if(typeof globalThis.localStorage!=`object`)return!1}catch{return!1}if(Rt.tested)return Rt.writable;let e=`lswt-${Math.random()}${Math.random()}`;try{globalThis.localStorage.setItem(e,e),globalThis.localStorage.removeItem(e),Rt.tested=!0,Rt.writable=!0}catch{Rt.tested=!0,Rt.writable=!1}return Rt.writable})()&&globalThis.localStorage&&globalThis.localStorage.getItem(`supabase.gotrue-js.locks.debug`);function zt(){if(typeof globalThis!=`object`)try{Object.defineProperty(Object.prototype,"__magic__",{get:function(){return this},configurable:!0}),__magic__.globalThis=__magic__,delete Object.prototype.__magic__}catch{typeof self<`u`&&(self.globalThis=self)}}new class{createNewAbortSignal(){if(this.controller){let e=Error(`Cancelling existing WebAuthn API call for new one`);e.name=`AbortError`,this.controller.abort(e)}let e=new AbortController;return this.controller=e,e.signal}cancelCeremony(){if(this.controller){let e=Error(`Manually cancelling existing WebAuthn API call`);e.name=`AbortError`,this.controller.abort(e),this.controller=void 0}}},zt();var Bt=`2.112.3`,Vt=``,Ht;if(typeof Deno<`u`)Vt=`deno`,Ht=Deno.version?.deno;else if(typeof document<`u`)Vt=`web`;else if(typeof navigator<`u`&&navigator.product===`ReactNative`)Vt=`react-native`;else{var Ut;Vt=`node`;let e=globalThis.process;Ht=e==null||(Ut=e.version)==null?void 0:Ut.replace(/^v/,``)}var Wt=[`runtime=${Vt}`];Ht&&Wt.push(`runtime-version=${Ht}`),`${Bt}${Wt.join(`; `)}`;function Gt(){if(typeof window<`u`||globalThis.Deno!==void 0)return!1;let e=globalThis.process;if(!e)return!1;let t=e.version;if(t==null)return!1;let n=t.match(/^v(\d+)\./);return n?parseInt(n[1],10)<=20:!1}Gt()&&console.warn(`⚠️  Node.js 20 and below are deprecated and will no longer be supported in future versions of @supabase/supabase-js. Please upgrade to Node.js 22 or later. For more information, visit: https://github.com/orgs/supabase/discussions/45715`);var Kt=[{id:`respiratory`,title:`Respiratory Issues`,subtitle:`Asthma, cough & breathing difficulty`,iconName:`Wind`,color:`#0284c7`,badge:`Popular`},{id:`piles`,title:`Piles`,subtitle:`Hemorrhoids & anal discomfort`,iconName:`Activity`,color:`#0d9488`},{id:`typhoid`,title:`Typhoid`,subtitle:`Bacterial infection needing urgent care`,iconName:`Thermometer`,color:`#e11d48`},{id:`dengue`,title:`Dengue Fever`,subtitle:`Children's health, fever & dengue`,iconName:`Bug`,color:`#ea580c`},{id:`kidney`,title:`Kidney Problems`,subtitle:`Kidney stones & urinary tract care`,iconName:`Droplet`,color:`#2563eb`},{id:`stomach`,title:`Stomach Issues`,subtitle:`Acid reflux, gastritis & digestion`,iconName:`ShieldAlert`,color:`#16a34a`},{id:`heart`,title:`Heart Disease`,subtitle:`Chest pain, cardiac conditions & checkups`,iconName:`Heart`,color:`#dc2626`}],qt=[{id:`dr-ahmed-ali`,name:`Dr. Ahmed Ali`,specialty:`Cardiologist`,specialtyId:`heart`,experience:`12 years of Experience`,rating:4.8,reviewsCount:142,hospital:`Shaukat Khanum Hospital, Lahore`,hours:`Mon-Fri: 9am-5pm`,image:`/assets/doc_real_2.jpg`,fee:`Rs. 2,500`,about:`Senior Consultant Cardiologist specializing in preventive cardiology, echocardiography, and heart disease management.`,availableDays:[`Monday`,`Tuesday`,`Wednesday`,`Thursday`,`Friday`]},{id:`dr-sarah-khan`,name:`Dr. Sarah Khan`,specialty:`Dermatologist`,specialtyId:`stomach`,experience:`8 years of Experience`,rating:4.9,reviewsCount:198,hospital:`Skin Care Clinic, Karachi`,hours:`Tue-Sat: 10am-4pm`,image:`/assets/doc_real_1.jpg`,fee:`Rs. 2,000`,about:`Expert clinical and aesthetic dermatologist with specialized training in laser treatments and skin care.`,availableDays:[`Tuesday`,`Wednesday`,`Thursday`,`Friday`,`Saturday`]},{id:`dr-muhammad-hassan`,name:`Dr. Muhammad Hassan`,specialty:`Neurologist`,specialtyId:`respiratory`,experience:`15 years of Experience`,rating:4.7,reviewsCount:89,hospital:`JPMC Hospital, Karachi`,hours:`Mon-Thu: 10am-3pm`,image:`/assets/doc_real_3.jpg`,fee:`Rs. 3,000`,about:`Renowned neurologist with extensive experience in brain disorders, stroke management, and nerve care.`,availableDays:[`Monday`,`Tuesday`,`Wednesday`,`Thursday`]},{id:`dr-ayesha-malik`,name:`Dr. Ayesha Malik`,specialty:`Pediatrician`,specialtyId:`dengue`,experience:`10 years of Experience`,rating:4.9,reviewsCount:230,hospital:`Children's Hospital, Islamabad`,hours:`Mon-Sun: 8am-8pm`,image:`/assets/doc_real_4.jpg`,fee:`Rs. 1,800`,about:`Compassionate pediatrician focusing on infant growth, childhood vaccinations, and general child healthcare.`,availableDays:[`Monday`,`Tuesday`,`Wednesday`,`Thursday`,`Friday`,`Saturday`,`Sunday`]},{id:`dr-tariq-mahmood`,name:`Dr. Tariq Mahmood`,specialty:`Gastroenterologist`,specialtyId:`stomach`,experience:`14 years of Experience`,rating:4.8,reviewsCount:115,hospital:`Aga Khan Hospital, Karachi`,hours:`Mon-Sat: 11am-6pm`,image:`/assets/doctor_ahmed.png`,fee:`Rs. 2,800`,about:`Specialist in digestive health, liver care, and modern endoscopic procedures.`,availableDays:[`Monday`,`Tuesday`,`Wednesday`,`Thursday`,`Friday`,`Saturday`]}],Jt=[`9:00 AM`,`9:30 AM`,`10:00 AM`,`10:30 AM`,`11:00 AM`,`11:30 AM`,`12:00 PM`,`12:30 PM`,`1:00 PM`,`1:30 PM`,`2:00 PM`,`2:30 PM`],Yt={badge:`DAILY WELLNESS INSIGHT`,title:`Maintain Optimal Hydration`,description:`Clinical guidelines recommend 6–8 glasses of water daily to support kidney function and metabolic balance.`},Xt=`medic_appointments_db`,Zt=`medic_auth_user`,Qt=`medic_registered_doctors`,$t=[{email:`patient@medic.com`,password:`password123`,fullName:`Zunaira Mughal`,role:`patient`,specialty:``,hospital:``,image:``},{email:`dr.ahmed@medic.com`,password:`password123`,fullName:`Dr. Ahmed Ali`,role:`doctor`,specialty:`Cardiologist (Heart)`,hospital:`Shaukat Khanum Hospital, Lahore`,experience:`12 years of Experience`,fee:`Rs. 2,500`,image:`/assets/doc_real_2.jpg`},{email:`dr.sarah@medic.com`,password:`password123`,fullName:`Dr. Sarah Khan`,role:`doctor`,specialty:`Dermatologist (Skin)`,hospital:`Skin Care Clinic, Karachi`,experience:`8 years of Experience`,fee:`Rs. 2,000`,image:`/assets/doc_real_1.jpg`},{email:`dr.hassan@medic.com`,password:`password123`,fullName:`Dr. Muhammad Hassan`,role:`doctor`,specialty:`Neurologist (Brain & Nerves)`,hospital:`City Brain & Spine Center`,experience:`15 years of Experience`,fee:`Rs. 3,000`,image:`/assets/doc_real_3.jpg`},{email:`dr.ayesha@medic.com`,password:`password123`,fullName:`Dr. Ayesha Malik`,role:`doctor`,specialty:`Pediatrician (Child Specialist)`,hospital:`Children Medical Complex`,experience:`7 years of Experience`,fee:`Rs. 1,800`,image:`/assets/doc_real_4.jpg`}],en=()=>{try{let e=localStorage.getItem(Zt);return e?JSON.parse(e):null}catch{return null}},tn=e=>{try{e?localStorage.setItem(Zt,JSON.stringify(e)):localStorage.removeItem(Zt)}catch(e){console.error(`Error saving user:`,e)}},nn=()=>{try{let e=localStorage.getItem(Qt);return[...e?JSON.parse(e):[],...qt]}catch{return qt}},rn=e=>{try{let t=localStorage.getItem(Qt),n=t?JSON.parse(t):[],r=n.findIndex(t=>t.id===e.id||t.email===e.email),i;return r>=0?(i=[...n],i[r]={...i[r],...e}):i=[e,...n],localStorage.setItem(Qt,JSON.stringify(i)),i}catch(e){return console.error(`Error saving doctor profile:`,e),[]}},an=()=>{try{let e=localStorage.getItem(Xt);return e?JSON.parse(e):[]}catch(e){return console.error(`Error reading appointments from storage:`,e),[]}},on=e=>{try{let t=[e,...an()];return localStorage.setItem(Xt,JSON.stringify(t)),t}catch(e){return console.error(`Error saving appointment:`,e),[]}},sn=(e,t)=>{try{let n=an().map(n=>n.id===e?{...n,status:t}:n);return localStorage.setItem(Xt,JSON.stringify(n)),n}catch(e){return console.error(`Error updating appointment status:`,e),[]}},cn=e=>sn(e,`Cancelled`),ln=async(e,t,n={})=>{let r=n.role===`doctor`,i={id:`usr_${Date.now()}`,email:e,fullName:n.fullName||(r?`Dr. Ahmed Ali`:`Zunaira Mughal`),role:n.role||`patient`,specialty:n.specialty||`General Practitioner`,hospital:n.hospital||`Medic City Hospital`,experience:n.experience||`6 years of Experience`,fee:n.fee||`Rs. 2,000`,image:n.image||`/assets/doc_real_2.jpg`,hours:n.hours||`Mon-Fri: 9am-5pm`,rating:4.9,provider:`medic_auth`};return tn(i),r&&rn(i),i},un=async(e,t)=>{let n=$t.find(t=>t.email.toLowerCase()===e.toLowerCase());if(n){let e={id:`usr_${n.role}_${Date.now()}`,email:n.email,fullName:n.fullName,role:n.role,specialty:n.specialty,hospital:n.hospital,experience:n.experience||`10 years of Experience`,fee:n.fee||`Rs. 2,500`,image:n.image||`/assets/doc_real_2.jpg`,hours:`Mon-Fri: 9am-5pm`,provider:`preset_mock`};return tn(e),e.role===`doctor`&&rn(e),e}let r=e.toLowerCase().includes(`dr`)||e.toLowerCase().includes(`doctor`),i={id:`usr_demo_${Date.now()}`,email:e,fullName:r?`Dr. Ahmed Ali`:`Zunaira Mughal`,role:r?`doctor`:`patient`,specialty:r?`Cardiologist`:``,hospital:r?`Shaukat Khanum Hospital, Lahore`:``,experience:`12 years of Experience`,fee:`Rs. 2,500`,image:r?`/assets/doc_real_2.jpg`:``,hours:`Mon-Fri: 9am-5pm`,provider:`local`};return tn(i),i},dn=async()=>{tn(null)};function fn({isRegister:e=!1,onAuthSuccess:t,onBack:n}){let[r,i]=(0,_.useState)(e?`register`:`login`),[a,o]=(0,_.useState)(`patient`),[s,c]=(0,_.useState)(`dr.ahmed@medic.com`),[l,u]=(0,_.useState)(`password123`),[d,f]=(0,_.useState)(`Dr. Ahmed Ali`),[p,m]=(0,_.useState)(`Cardiologist (Heart)`),[h,g]=(0,_.useState)(`Shaukat Khanum Hospital, Lahore`),[v,y]=(0,_.useState)(`10 years of Experience`),[b,x]=(0,_.useState)(`Rs. 2,500`),[ee,S]=(0,_.useState)(`/assets/doc_real_2.jpg`),[C,te]=(0,_.useState)(!1),[ne,re]=(0,_.useState)(!1),[w,ie]=(0,_.useState)(``),[se,ce]=(0,_.useState)(``),le=e=>{let t=e.target.files?.[0];if(t){let e=new FileReader;e.onloadend=()=>{S(e.result)},e.readAsDataURL(t)}},ue=e=>{c(e.email),u(e.password),f(e.fullName),e.role===`doctor`?(o(`doctor`),m(e.specialty||`Cardiologist`),g(e.hospital||`Shaukat Khanum Hospital`),S(e.image||`/assets/doc_real_2.jpg`)):o(`patient`),ie(``)};return(0,k.jsxs)(`div`,{className:`auth-screen animate-slide-up`,children:[(0,k.jsxs)(`div`,{className:`auth-header`,children:[(0,k.jsx)(`button`,{className:`back-btn`,onClick:n,children:(0,k.jsx)(ae,{size:20,color:`#0b5d71`})}),(0,k.jsxs)(`div`,{className:`doctor-animation-wrapper`,children:[(0,k.jsx)(`div`,{className:`pulse-circle`}),(0,k.jsx)(`div`,{className:`pulse-circle delay-1`}),(0,k.jsx)(`div`,{className:`doctor-icon-container`,children:(0,k.jsx)(ze,{size:48,color:`#0b5d71`,strokeWidth:1.5})})]})]}),(0,k.jsxs)(`div`,{className:`auth-card`,children:[(0,k.jsx)(`h2`,{className:`auth-title`,children:r===`login`?`Welcome Back`:a===`doctor`?`Doctor Registration`:`Patient Registration`}),(0,k.jsx)(`p`,{className:`auth-subtitle`,children:r===`login`?`Sign in to manage appointments & doctor requests`:`Fill in your credentials to create your account`}),r===`login`&&(0,k.jsxs)(`div`,{className:`login-role-cards`,children:[(0,k.jsxs)(`button`,{type:`button`,className:`role-card ${a===`patient`?`active`:``}`,onClick:()=>{o(`patient`),ue($t.find(e=>e.role===`patient`))},children:[(0,k.jsx)(`div`,{className:`role-icon-box ${a===`patient`?`active-icon`:``}`,children:(0,k.jsx)(He,{size:24})}),(0,k.jsxs)(`div`,{className:`role-card-text`,children:[(0,k.jsx)(`span`,{className:`role-title`,children:`Patient Login`}),(0,k.jsx)(`span`,{className:`role-desc`,children:`Book & track visits`})]})]}),(0,k.jsxs)(`button`,{type:`button`,className:`role-card ${a===`doctor`?`active`:``}`,onClick:()=>{o(`doctor`),ue($t.find(e=>e.role===`doctor`))},children:[(0,k.jsx)(`div`,{className:`role-icon-box ${a===`doctor`?`active-icon`:``}`,children:(0,k.jsx)(ze,{size:24})}),(0,k.jsxs)(`div`,{className:`role-card-text`,children:[(0,k.jsx)(`span`,{className:`role-title`,children:`Doctor Portal`}),(0,k.jsx)(`span`,{className:`role-desc`,children:`Manage your practice`})]})]})]}),r===`register`&&(0,k.jsxs)(`div`,{className:`role-selector-bar`,children:[(0,k.jsxs)(`button`,{type:`button`,className:`role-tab ${a===`patient`?`active`:``}`,onClick:()=>{o(`patient`),f(`Zunaira Mughal`),c(`patient@medic.com`)},children:[(0,k.jsx)(He,{size:16}),(0,k.jsx)(`span`,{children:`Patient`})]}),(0,k.jsxs)(`button`,{type:`button`,className:`role-tab ${a===`doctor`?`active`:``}`,onClick:()=>{o(`doctor`),f(`Dr. Ahmed Ali`),c(`dr.ahmed@medic.com`)},children:[(0,k.jsx)(ze,{size:16}),(0,k.jsx)(`span`,{children:`Doctor`})]})]}),w&&(0,k.jsxs)(`div`,{className:`auth-alert error-alert`,children:[(0,k.jsx)(D,{size:16}),(0,k.jsx)(`span`,{children:w})]}),se&&(0,k.jsxs)(`div`,{className:`auth-alert success-alert`,children:[(0,k.jsx)(O,{size:16}),(0,k.jsx)(`span`,{children:se})]}),(0,k.jsxs)(`form`,{onSubmit:async e=>{if(e.preventDefault(),re(!0),ie(``),ce(``),!s||!s.includes(`@`)){ie(`Please enter a valid email address.`),re(!1);return}if(l.length<6){ie(`Password must be at least 6 characters long.`),re(!1);return}try{if(r===`register`){if(!d.trim()){ie(`Please enter your full name.`),re(!1);return}let e={fullName:a===`doctor`&&!d.toLowerCase().startsWith(`dr.`)?`Dr. ${d}`:d,role:a,specialty:p,hospital:h,experience:v,fee:b,image:ee},n=await ln(s,l,e);ce(`${a===`doctor`?`Doctor Account`:`Patient Account`} created! Redirecting...`),setTimeout(()=>{re(!1),t(n)},800)}else{let e=await un(s,l);ce(`Signed in as ${e.fullName}!`),setTimeout(()=>{re(!1),t(e)},600)}}catch(e){console.error(`Authentication Error:`,e),re(!1),ie(e.message||`Authentication failed. Please check your credentials.`)}},className:`auth-form`,children:[r===`register`&&(0,k.jsxs)(k.Fragment,{children:[a===`doctor`&&(0,k.jsxs)(`div`,{className:`doctor-photo-uploader`,children:[(0,k.jsx)(`img`,{src:ee,alt:`Doctor Preview`,className:`uploaded-doc-preview`}),(0,k.jsxs)(`label`,{htmlFor:`photo-upload`,className:`upload-btn`,children:[(0,k.jsx)(Ve,{size:14}),(0,k.jsx)(`span`,{children:`Upload Profile Photo`}),(0,k.jsx)(`input`,{id:`photo-upload`,type:`file`,accept:`image/*`,onChange:le,style:{display:`none`}})]})]}),(0,k.jsxs)(`div`,{className:`input-group`,children:[(0,k.jsx)(He,{size:18,className:`input-icon`}),(0,k.jsx)(`input`,{type:`text`,className:`form-input`,placeholder:a===`doctor`?`Doctor Full Name (e.g. Dr. Ahmed Ali)`:`Full Name`,value:d,onChange:e=>f(e.target.value),required:!0})]}),a===`doctor`&&(0,k.jsxs)(k.Fragment,{children:[(0,k.jsxs)(`div`,{className:`input-group`,children:[(0,k.jsx)(ze,{size:18,className:`input-icon`}),(0,k.jsxs)(`select`,{className:`form-input select-input`,value:p,onChange:e=>m(e.target.value),children:[(0,k.jsx)(`option`,{value:`Cardiologist (Heart)`,children:`Cardiologist (Heart Specialist)`}),(0,k.jsx)(`option`,{value:`Dermatologist (Skin)`,children:`Dermatologist (Skin Specialist)`}),(0,k.jsx)(`option`,{value:`Neurologist (Brain & Nerves)`,children:`Neurologist (Brain & Nerves)`}),(0,k.jsx)(`option`,{value:`Pediatrician (Child)`,children:`Pediatrician (Child Specialist)`}),(0,k.jsx)(`option`,{value:`Gastroenterologist (Stomach)`,children:`Gastroenterologist (Stomach)`}),(0,k.jsx)(`option`,{value:`General Physician`,children:`General Physician`})]})]}),(0,k.jsxs)(`div`,{className:`input-group`,children:[(0,k.jsx)(T,{size:18,className:`input-icon`}),(0,k.jsx)(`input`,{type:`text`,className:`form-input`,placeholder:`Hospital / Clinic Name`,value:h,onChange:e=>g(e.target.value),required:!0})]}),(0,k.jsxs)(`div`,{className:`input-row-flex`,children:[(0,k.jsxs)(`div`,{className:`input-group flex-1`,children:[(0,k.jsx)(oe,{size:18,className:`input-icon`}),(0,k.jsx)(`input`,{type:`text`,className:`form-input`,placeholder:`Experience (e.g. 10 yrs)`,value:v,onChange:e=>y(e.target.value)})]}),(0,k.jsxs)(`div`,{className:`input-group flex-1`,children:[(0,k.jsx)(ye,{size:18,className:`input-icon`}),(0,k.jsx)(`input`,{type:`text`,className:`form-input`,placeholder:`Fee (e.g. Rs. 2,500)`,value:b,onChange:e=>x(e.target.value)})]})]})]})]}),(0,k.jsxs)(`div`,{className:`input-group`,children:[(0,k.jsx)(Oe,{size:18,className:`input-icon`}),(0,k.jsx)(`input`,{type:`email`,className:`form-input`,placeholder:`Email Address`,value:s,onChange:e=>c(e.target.value),required:!0})]}),(0,k.jsxs)(`div`,{className:`input-group`,children:[(0,k.jsx)(Ee,{size:18,className:`input-icon`}),(0,k.jsx)(`input`,{type:C?`text`:`password`,className:`form-input`,placeholder:`Password (min 6 chars)`,value:l,onChange:e=>u(e.target.value),required:!0}),(0,k.jsx)(`button`,{type:`button`,className:`eye-toggle`,onClick:()=>te(!C),children:C?(0,k.jsx)(xe,{size:18,color:`#94a3b8`}):(0,k.jsx)(Se,{size:18,color:`#94a3b8`})})]}),(0,k.jsx)(`button`,{type:`submit`,className:`submit-btn`,disabled:ne,children:ne?(0,k.jsx)(`span`,{className:`spinner-text`,children:`Processing...`}):r===`login`?`Sign In`:a===`doctor`?`Register as Doctor`:`Register as Patient`})]}),(0,k.jsx)(`div`,{className:`auth-footer-toggle`,children:r===`login`?(0,k.jsxs)(`p`,{children:[`Don't have an account?`,` `,(0,k.jsx)(`button`,{type:`button`,className:`link-btn`,onClick:()=>{i(`register`),ie(``),ce(``)},children:`Sign Up`})]}):(0,k.jsxs)(`p`,{children:[`Already have an account?`,` `,(0,k.jsx)(`button`,{type:`button`,className:`link-btn`,onClick:()=>{i(`login`),ie(``),ce(``)},children:`Sign In`})]})})]}),(0,k.jsx)(`style`,{children:`
        .auth-screen {
          position: absolute;
          inset: 0;
      ...
      `})]})}var pn={Wind:qe,Activity:ie,Thermometer:Be,Bug:ue,Droplet:be,ShieldAlert:Pe,Heart:we};function mn({user:e,onSelectDoctor:t,onViewAllSpecialties:n,onViewAllDoctors:r}){let i=e?.role===`doctor`,[a,o]=(0,_.useState)([]),[s,c]=(0,_.useState)([]);(0,_.useEffect)(()=>{let e=nn();o(e);let t=an();c(t)},[]);let l=(e,t)=>{let n=sn(e,t);c(n)},u=s.filter(e=>e.status===`Pending`),d=s.filter(e=>e.status===`Accepted`||e.status===`Confirmed`);return(0,k.jsxs)(`div`,{className:`home-screen animate-fade-in`,children:[(0,k.jsxs)(`div`,{className:`home-header`,children:[(0,k.jsxs)(`div`,{className:`user-greeting`,children:[(0,k.jsx)(`div`,{className:`avatar-circle`,children:e?.image?(0,k.jsx)(`img`,{src:e.image,alt:e.fullName,className:`header-avatar-img`}):(0,k.jsx)(`span`,{className:`avatar-text`,children:e?.fullName?.charAt(0)||`D`})}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`div`,{className:`greeting-role-tag`,children:(0,k.jsx)(`span`,{className:`role-badge ${i?`doc-badge`:`pat-badge`}`,children:i?`Doctor Portal`:`Patient Portal`})}),(0,k.jsx)(`h3`,{className:`greeting-name`,children:e?.fullName||`Zunaira Mughal`})]})]}),(0,k.jsxs)(`button`,{className:`icon-badge-btn`,onClick:r,children:[(0,k.jsx)(ce,{size:20,color:`#0b5d71`}),u.length>0&&(0,k.jsx)(`span`,{className:`dot-badge`})]})]}),i?(0,k.jsxs)(`div`,{className:`doctor-portal-view`,children:[(0,k.jsxs)(`div`,{className:`doctor-info-hero`,children:[(0,k.jsxs)(`div`,{className:`hero-doc-flex`,children:[(0,k.jsx)(`img`,{src:e?.image||`/assets/doc_real_2.jpg`,alt:e?.fullName,className:`hero-doc-img`}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`h3`,{className:`hero-doc-name`,children:e?.fullName}),(0,k.jsxs)(`p`,{className:`hero-doc-spec`,children:[e?.specialty||`Cardiologist`,` • `,e?.experience||`10 yrs exp`]}),(0,k.jsx)(`p`,{className:`hero-doc-hosp`,children:e?.hospital||`Medic Hospital`})]})]}),(0,k.jsxs)(`div`,{className:`doc-stats-grid`,children:[(0,k.jsxs)(`div`,{className:`stat-card`,children:[(0,k.jsx)(`span`,{className:`stat-num`,children:s.length}),(0,k.jsx)(`span`,{className:`stat-label`,children:`Total Requests`})]}),(0,k.jsxs)(`div`,{className:`stat-card gold`,children:[(0,k.jsx)(`span`,{className:`stat-num`,children:u.length}),(0,k.jsx)(`span`,{className:`stat-label`,children:`Pending`})]}),(0,k.jsxs)(`div`,{className:`stat-card green`,children:[(0,k.jsx)(`span`,{className:`stat-num`,children:d.length}),(0,k.jsx)(`span`,{className:`stat-label`,children:`Accepted`})]})]})]}),(0,k.jsxs)(`div`,{className:`section-container`,style:{marginTop:`16px`},children:[(0,k.jsx)(`h3`,{className:`section-title`,style:{marginBottom:`12px`},children:`Practice Management`}),(0,k.jsxs)(`div`,{className:`doc-quick-actions-grid`,children:[(0,k.jsxs)(`button`,{className:`doc-action-btn`,children:[(0,k.jsx)(`div`,{className:`doc-action-icon blue`,children:(0,k.jsx)(E,{size:20})}),(0,k.jsx)(`span`,{children:`Schedule`})]}),(0,k.jsxs)(`button`,{className:`doc-action-btn`,children:[(0,k.jsx)(`div`,{className:`doc-action-icon green`,children:(0,k.jsx)(We,{size:20})}),(0,k.jsx)(`span`,{children:`Telehealth`})]}),(0,k.jsxs)(`button`,{className:`doc-action-btn`,children:[(0,k.jsx)(`div`,{className:`doc-action-icon purple`,children:(0,k.jsx)(Ue,{size:20})}),(0,k.jsx)(`span`,{children:`My Patients`})]}),(0,k.jsxs)(`button`,{className:`doc-action-btn`,children:[(0,k.jsx)(`div`,{className:`doc-action-icon orange`,children:(0,k.jsx)(Ge,{size:20})}),(0,k.jsx)(`span`,{children:`Earnings`})]})]})]}),(0,k.jsxs)(`div`,{className:`section-container`,children:[(0,k.jsx)(`div`,{className:`section-header`,children:(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`h3`,{className:`section-title`,children:`Patient Appointment Requests`}),(0,k.jsx)(`p`,{className:`section-subtitle`,children:`Review and accept incoming consultation requests`})]})}),s.length===0?(0,k.jsxs)(`div`,{className:`empty-requests-card`,children:[(0,k.jsx)(de,{size:36,color:`#94a3b8`}),(0,k.jsx)(`p`,{className:`empty-title`,children:`No pending requests`}),(0,k.jsx)(`p`,{className:`empty-sub`,children:`Patient bookings will appear here instantly.`})]}):(0,k.jsx)(`div`,{className:`requests-list-flex`,children:s.map(e=>(0,k.jsxs)(`div`,{className:`request-card-item`,children:[(0,k.jsxs)(`div`,{className:`request-card-top`,children:[(0,k.jsx)(`div`,{className:`patient-avatar-box`,children:(0,k.jsx)(He,{size:20,color:`#0b5d71`})}),(0,k.jsxs)(`div`,{className:`patient-info`,children:[(0,k.jsx)(`h4`,{className:`patient-name`,children:e.patientName||`Zunaira Mughal`}),(0,k.jsxs)(`p`,{className:`patient-contact`,children:[`📞 `,e.contactNumber||`03010123456`]})]}),(0,k.jsx)(`span`,{className:`status-pill ${e.status?.toLowerCase()}`,children:e.status||`Pending`})]}),(0,k.jsxs)(`div`,{className:`request-details-bar`,children:[(0,k.jsxs)(`div`,{className:`req-meta`,children:[(0,k.jsx)(de,{size:13,color:`#0b5d71`}),(0,k.jsxs)(`span`,{children:[e.dayFormatted,`, `,e.dateFormatted]})]}),(0,k.jsxs)(`div`,{className:`req-meta`,children:[(0,k.jsx)(_e,{size:13,color:`#0b5d71`}),(0,k.jsxs)(`span`,{children:[e.timeSlot,` (`,e.consultationType,`)`]})]})]}),e.status===`Pending`?(0,k.jsxs)(`div`,{className:`request-actions-row`,children:[(0,k.jsxs)(`button`,{className:`btn-accept`,onClick:()=>l(e.id,`Accepted`),children:[(0,k.jsx)(pe,{size:16}),` Accept Request`]}),(0,k.jsxs)(`button`,{className:`btn-decline`,onClick:()=>l(e.id,`Declined`),children:[(0,k.jsx)(Je,{size:16}),` Decline`]})]}):(0,k.jsxs)(`div`,{className:`status-updated-confirmed`,children:[(0,k.jsx)(O,{size:16,color:`#166534`}),(0,k.jsxs)(`span`,{children:[`Appointment Status Updated: `,(0,k.jsx)(`strong`,{children:e.status})]})]})]},e.id))})]})]}):(0,k.jsxs)(`div`,{className:`patient-portal-view`,children:[(0,k.jsxs)(`div`,{className:`search-bar-wrapper`,onClick:r,children:[(0,k.jsx)(Ne,{size:18,color:`#94a3b8`}),(0,k.jsx)(`span`,{className:`search-placeholder`,children:`Search doctor, specialty, hospital...`})]}),(0,k.jsxs)(`div`,{className:`section-container`,children:[(0,k.jsxs)(`div`,{className:`section-header`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`h3`,{className:`section-title`,children:`Browse by Specialty`}),(0,k.jsx)(`p`,{className:`section-subtitle`,children:`Find care for your condition`})]}),(0,k.jsx)(`button`,{className:`view-all-btn`,onClick:n,children:`View All`})]}),(0,k.jsx)(`div`,{className:`specialty-horizontal-scroll`,children:Kt.map(e=>{let t=pn[e.iconName]||ie;return(0,k.jsxs)(`div`,{className:`specialty-chip-card`,onClick:()=>n(e.id),children:[(0,k.jsx)(`div`,{className:`spec-icon-wrapper`,style:{backgroundColor:`${e.color}15`,color:e.color},children:(0,k.jsx)(t,{size:22})}),(0,k.jsx)(`span`,{className:`spec-card-title`,children:e.title})]},e.id)})})]}),(0,k.jsxs)(`div`,{className:`section-container`,children:[(0,k.jsxs)(`div`,{className:`section-header`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`h3`,{className:`section-title`,children:`Available Doctors`}),(0,k.jsx)(`p`,{className:`section-subtitle`,children:`Ready to consult today`})]}),(0,k.jsx)(`button`,{className:`view-all-btn`,onClick:r,children:`View All`})]}),(0,k.jsx)(`div`,{className:`doctors-horizontal-scroll`,children:a.map(e=>(0,k.jsxs)(`div`,{className:`available-doctor-card`,children:[(0,k.jsx)(`img`,{src:e.image,alt:e.name,className:`doctor-card-img`}),(0,k.jsxs)(`div`,{className:`doc-card-body`,children:[(0,k.jsx)(`h4`,{className:`doc-card-name`,children:e.name}),(0,k.jsx)(`p`,{className:`doc-card-spec`,children:e.specialty}),(0,k.jsx)(`div`,{className:`doc-card-meta`,children:(0,k.jsx)(`span`,{className:`hours-tag`,children:e.hours||`Mon-Fri: 9am-5pm`})}),(0,k.jsxs)(`div`,{className:`doc-card-rating`,children:[(0,k.jsx)(Re,{size:14,fill:`#f59e0b`,color:`#f59e0b`}),(0,k.jsx)(`span`,{className:`rating-num`,children:e.rating||4.9}),(0,k.jsxs)(`span`,{className:`exp-text`,children:[`• `,e.experience?.split(` `)[0]||8,` yrs exp`]})]}),(0,k.jsx)(`button`,{className:`book-now-btn`,onClick:()=>t(e),children:`Book now`})]})]},e.id))})]}),(0,k.jsx)(`div`,{className:`section-container`,children:(0,k.jsxs)(`div`,{className:`wellness-insight-card`,children:[(0,k.jsxs)(`div`,{className:`wellness-badge-row`,children:[(0,k.jsx)(`span`,{className:`insight-gold-dot`,children:`💡`}),(0,k.jsx)(`span`,{className:`wellness-badge-title`,children:Yt.badge})]}),(0,k.jsxs)(`div`,{className:`insight-content-flex`,children:[(0,k.jsx)(`div`,{className:`insight-icon-box`,children:(0,k.jsx)(be,{size:24,color:`#0b5d71`})}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`h4`,{className:`insight-title`,children:Yt.title}),(0,k.jsx)(`p`,{className:`insight-desc`,children:Yt.description})]})]})]})})]}),(0,k.jsx)(`style`,{children:`
        .home-screen {
          position: absolute;
          inset: 0;
          overflow-y: auto;
      ...
      `})]})}var hn={Wind:qe,Activity:ie,Thermometer:Be,Bug:ue,Droplet:be,ShieldAlert:Pe,Heart:we};function gn({onBack:e,onSelectSpecialty:t}){return(0,k.jsxs)(`div`,{className:`specialties-screen animate-slide-up`,children:[(0,k.jsxs)(`div`,{className:`specialties-header`,children:[(0,k.jsx)(`button`,{className:`back-btn`,onClick:e,children:(0,k.jsx)(ae,{size:20,color:`#ffffff`})}),(0,k.jsx)(`h2`,{className:`header-title`,children:`Browse by Specialty`})]}),(0,k.jsx)(`div`,{className:`specialties-list`,children:Kt.map(e=>{let n=hn[e.iconName]||ie;return(0,k.jsxs)(`div`,{className:`specialty-item-card`,onClick:()=>t(e),children:[(0,k.jsx)(`div`,{className:`specialty-icon-box`,children:(0,k.jsx)(n,{size:24,color:`#0b5d71`})}),(0,k.jsxs)(`div`,{className:`specialty-info`,children:[(0,k.jsx)(`h4`,{className:`specialty-title`,children:e.title}),(0,k.jsx)(`p`,{className:`specialty-subtitle`,children:e.subtitle})]}),(0,k.jsx)(me,{size:18,color:`#94a3b8`,className:`chevron-icon`})]},e.id)})}),(0,k.jsx)(`style`,{children:`
        .specialties-screen {
          position: absolute;
          inset: 0;
          background: #f5f9fc;
      ...
      `})]})}var _n=(e,t=``,n=`all`,r=`all`,i=!1)=>{if(!e||!Array.isArray(e))return[];let a=t.trim().toLowerCase().replace(/^(dr\.\s*|dr\s*)/i,``).split(/\s+/).filter(Boolean);return e.filter(e=>{if(n!==`all`&&e.specialtyId!==n||i&&(e.rating||0)<4.8)return!1;if(r!==`all`){let t=parseInt((e.fee||``).replace(/[^0-9]/g,``))||2e3;if(r===`under2k`&&t>2e3||r===`2kto3k`&&(t<2e3||t>3e3)||r===`above3k`&&t<3e3)return!1}if(a.length===0)return!0;let t=[e.name||``,e.specialty||``,e.hospital||``,e.about||``,e.fee||``,e.hours||``,e.experience||``].join(` `).toLowerCase();return a.every(e=>t.includes(e))})};function vn({onBack:e,onSelectDoctor:t,initialSpecialtyId:n}){let[r,i]=(0,_.useState)(``),[a,o]=(0,_.useState)(n||`all`),[s,c]=(0,_.useState)(`all`),[l,u]=(0,_.useState)(!1),[d,f]=(0,_.useState)([]);(0,_.useEffect)(()=>{f(nn())},[]);let p=_n(d,r,a,s,l);return(0,k.jsxs)(`div`,{className:`doctors-list-screen animate-fade-in`,children:[(0,k.jsxs)(`div`,{className:`doctors-header`,children:[(0,k.jsx)(`button`,{className:`back-btn`,onClick:e,children:(0,k.jsx)(ae,{size:20,color:`#ffffff`})}),(0,k.jsx)(`h2`,{className:`header-title`,children:`Smart Doctor Search`}),(0,k.jsxs)(`div`,{className:`header-badge-count`,children:[p.length,` Found`]})]}),(0,k.jsxs)(`div`,{className:`filter-sticky-bar`,children:[(0,k.jsxs)(`div`,{className:`search-input-box`,children:[(0,k.jsx)(Ne,{size:18,color:`#0b5d71`,className:`search-icon-anim`}),(0,k.jsx)(`input`,{type:`text`,className:`search-input`,placeholder:`Search name, hospital, city, fee (e.g. Sarah Karachi)...`,value:r,onChange:e=>i(e.target.value)}),r&&(0,k.jsx)(`button`,{className:`clear-search-btn`,onClick:()=>i(``),children:`×`})]}),(0,k.jsxs)(`div`,{className:`secondary-filters-row`,children:[(0,k.jsxs)(`button`,{className:`quick-pill ${l?`active`:``}`,onClick:()=>u(!l),children:[(0,k.jsx)(Re,{size:13,fill:l?`#ffffff`:`#f59e0b`,color:l?`#ffffff`:`#f59e0b`}),(0,k.jsx)(`span`,{children:`Top Rated (4.8+)`})]}),(0,k.jsxs)(`select`,{className:`fee-select-pill`,value:s,onChange:e=>c(e.target.value),children:[(0,k.jsx)(`option`,{value:`all`,children:`Any Fee`}),(0,k.jsx)(`option`,{value:`under2k`,children:`Under Rs. 2,000`}),(0,k.jsx)(`option`,{value:`2kto3k`,children:`Rs. 2,000 - Rs. 3,000`}),(0,k.jsx)(`option`,{value:`above3k`,children:`Above Rs. 3,000`})]})]}),(0,k.jsxs)(`div`,{className:`spec-filter-scroll`,children:[(0,k.jsx)(`button`,{className:`filter-chip ${a===`all`?`active`:``}`,onClick:()=>o(`all`),children:`All Specialties`}),Kt.map(e=>(0,k.jsx)(`button`,{className:`filter-chip ${a===e.id?`active`:``}`,onClick:()=>o(e.id),children:e.title},e.id))]})]}),(0,k.jsxs)(`div`,{className:`results-summary-row`,children:[(0,k.jsxs)(`span`,{className:`results-count-text`,children:[p.length,` `,p.length===1?`Specialist`:`Specialists`,` Matched`]}),(r||a!==`all`||s!==`all`||l)&&(0,k.jsx)(`button`,{className:`reset-filters-btn`,onClick:()=>{i(``),o(`all`),c(`all`),u(!1)},children:`Reset Filters`})]}),(0,k.jsx)(`div`,{className:`doctors-cards-list`,children:p.length===0?(0,k.jsxs)(`div`,{className:`no-results-card`,children:[(0,k.jsx)(Ce,{size:36,color:`#94a3b8`}),(0,k.jsx)(`h4`,{className:`no-results-title`,children:`No matching doctors found`}),(0,k.jsx)(`p`,{className:`no-results-sub`,children:`Try searching with a broader keyword or reset your filter criteria.`}),(0,k.jsx)(`button`,{className:`reset-search-btn`,onClick:()=>{i(``),o(`all`),c(`all`),u(!1)},children:`Clear All Filters`})]}):p.map(e=>(0,k.jsxs)(`div`,{className:`doctor-full-card animate-slide-up`,onClick:()=>t(e),children:[(0,k.jsxs)(`div`,{className:`doc-card-top-row`,children:[(0,k.jsxs)(`div`,{className:`doc-avatar-container`,children:[(0,k.jsx)(`img`,{src:e.image,alt:e.name,className:`doc-avatar-img`}),(0,k.jsx)(`span`,{className:`online-indicator-dot`,title:`Available Today`})]}),(0,k.jsxs)(`div`,{className:`doc-main-info`,children:[(0,k.jsxs)(`div`,{className:`doc-name-flex`,children:[(0,k.jsx)(`h3`,{className:`doc-name-heading`,children:e.name}),(0,k.jsxs)(`div`,{className:`doc-rating-badge`,children:[(0,k.jsx)(Re,{size:12,fill:`#f59e0b`,color:`#f59e0b`}),(0,k.jsx)(`span`,{children:e.rating||4.9})]})]}),(0,k.jsx)(`p`,{className:`doc-spec-sub`,children:e.specialty}),(0,k.jsxs)(`p`,{className:`doc-exp-text`,children:[`✨ `,e.experience||`8 years exp`]})]})]}),(0,k.jsx)(`div`,{className:`doc-card-divider`}),(0,k.jsxs)(`div`,{className:`doc-card-footer`,children:[(0,k.jsxs)(`div`,{className:`footer-meta-column`,children:[(0,k.jsxs)(`div`,{className:`footer-info-row`,children:[(0,k.jsx)(ke,{size:13,color:`#0b5d71`}),(0,k.jsx)(`span`,{children:e.hospital})]}),(0,k.jsxs)(`div`,{className:`footer-info-row`,children:[(0,k.jsx)(_e,{size:13,color:`#0b5d71`}),(0,k.jsxs)(`span`,{children:[`Fee: `,(0,k.jsx)(`strong`,{style:{color:`#0b5d71`},children:e.fee||`Rs. 2,000`})]})]})]}),(0,k.jsx)(`button`,{className:`card-book-action-btn`,onClick:n=>{n.stopPropagation(),t(e)},children:`Book Visit`})]})]},e.id))}),(0,k.jsx)(`style`,{children:`
        .doctors-list-screen {
          position: absolute;
          inset: 0;
          background: #f5f9fc;
      ...
      `})]})}function yn({doctor:e,user:t,onBack:n,onBookingSuccess:r}){let[i,a]=(0,_.useState)(`In-person`),[o,s]=(0,_.useState)(t?.fullName||`Zunaira Mughal`),[c,l]=(0,_.useState)(`03010123456`),u=[{day:`Fri`,dateNum:`14`,full:`Friday, 14/08/2026`},{day:`Sat`,dateNum:`15`,full:`Saturday, 15/08/2026`},{day:`Sun`,dateNum:`16`,full:`Sunday, 16/08/2026`},{day:`Mon`,dateNum:`17`,full:`Monday, 17/08/2026`}],[d,f]=(0,_.useState)(u[0]),[p,m]=(0,_.useState)(`9:30 AM`),[h,g]=(0,_.useState)(!1);return(0,k.jsxs)(`div`,{className:`booking-screen animate-slide-up`,children:[(0,k.jsxs)(`div`,{className:`booking-header`,children:[(0,k.jsx)(`button`,{className:`back-btn`,onClick:n,children:(0,k.jsx)(ae,{size:20,color:`#ffffff`})}),(0,k.jsxs)(`h2`,{className:`header-title`,children:[`Book with `,e.name]})]}),(0,k.jsxs)(`form`,{onSubmit:async t=>{if(t.preventDefault(),!p)return;g(!0);let n={id:`apt_${Date.now()}`,doctorId:e.id,doctorName:e.name,doctorSpecialty:e.specialty,doctorImage:e.image,consultationType:i===`In-person`?`In-person Visit`:`Video Visit`,patientName:o,contactNumber:c,dateFormatted:d.full.split(`, `)[1],dayFormatted:d.full.split(`, `)[0],timeSlot:p,status:`Pending`,createdAt:new Date().toISOString()};on(n),setTimeout(()=>{g(!1),r(n)},600)},className:`booking-form-body`,children:[(0,k.jsxs)(`div`,{className:`form-section`,children:[(0,k.jsx)(`label`,{className:`section-label`,children:`Consultation type`}),(0,k.jsxs)(`div`,{className:`type-toggle-grid`,children:[(0,k.jsxs)(`button`,{type:`button`,className:`type-btn ${i===`In-person`?`active`:``}`,onClick:()=>a(`In-person`),children:[(0,k.jsx)(T,{size:18}),(0,k.jsx)(`span`,{children:`In-person`})]}),(0,k.jsxs)(`button`,{type:`button`,className:`type-btn ${i===`Video`?`active`:``}`,onClick:()=>a(`Video`),children:[(0,k.jsx)(We,{size:18}),(0,k.jsx)(`span`,{children:`Video`})]})]})]}),(0,k.jsxs)(`div`,{className:`form-section`,children:[(0,k.jsx)(`label`,{className:`section-label`,children:`Patient Name`}),(0,k.jsx)(`input`,{type:`text`,className:`styled-input`,value:o,onChange:e=>s(e.target.value),placeholder:`Enter your full name`,required:!0})]}),(0,k.jsxs)(`div`,{className:`form-section`,children:[(0,k.jsx)(`label`,{className:`section-label`,children:`Contact Number`}),(0,k.jsx)(`input`,{type:`tel`,className:`styled-input`,value:c,onChange:e=>l(e.target.value),placeholder:`Enter your mobile number`,required:!0})]}),(0,k.jsxs)(`div`,{className:`form-section`,children:[(0,k.jsxs)(`label`,{className:`section-label`,children:[`Select Date (`,d.full,`)`]}),(0,k.jsx)(`div`,{className:`dates-pill-row`,children:u.map(e=>(0,k.jsxs)(`button`,{type:`button`,className:`date-pill-btn ${d.dateNum===e.dateNum?`active`:``}`,onClick:()=>f(e),children:[(0,k.jsx)(`span`,{className:`pill-day`,children:e.day}),(0,k.jsx)(`span`,{className:`pill-num`,children:e.dateNum})]},e.dateNum))})]}),(0,k.jsxs)(`div`,{className:`form-section`,children:[(0,k.jsx)(`label`,{className:`section-label`,children:`Available Slots`}),(0,k.jsx)(`div`,{className:`slots-grid`,children:Jt.map(e=>(0,k.jsxs)(`button`,{type:`button`,className:`slot-chip ${p===e?`selected`:``}`,onClick:()=>m(e),children:[(0,k.jsx)(_e,{size:12,className:`slot-clock-icon`}),(0,k.jsx)(`span`,{children:e})]},e))})]}),(0,k.jsxs)(`button`,{type:`submit`,className:`confirm-btn`,disabled:h||!p,children:[(0,k.jsx)(de,{size:18,color:`#ffffff`}),(0,k.jsx)(`span`,{children:h?`Booking Appointment...`:`Confirm Appointment`})]})]}),(0,k.jsx)(`style`,{children:`
        .booking-screen {
          position: absolute;
          inset: 0;
          background: #ffffff;
      ...
      `})]})}function bn({appointment:e,onBack:t,onCancelled:n}){let[r,i]=(0,_.useState)(e),[a,o]=(0,_.useState)(!1);return(0,k.jsxs)(`div`,{className:`detail-screen animate-slide-up`,children:[(0,k.jsxs)(`div`,{className:`detail-header`,children:[(0,k.jsx)(`button`,{className:`back-btn`,onClick:t,children:(0,k.jsx)(ae,{size:20,color:`#ffffff`})}),(0,k.jsx)(`h2`,{className:`header-title`,children:`Appointment Detail`})]}),(0,k.jsxs)(`div`,{className:`detail-content-body`,children:[(0,k.jsxs)(`div`,{className:`doctor-status-card`,children:[(0,k.jsx)(`div`,{className:`doc-icon-badge`,children:(0,k.jsx)(le,{size:26,color:`#0b5d71`})}),(0,k.jsx)(`h3`,{className:`card-doctor-name`,children:r.doctorName||`Dr. Ahmed Ali`}),(0,k.jsxs)(`div`,{className:`status-pill ${r.status?.toLowerCase()||`pending`}`,children:[(0,k.jsx)(_e,{size:13}),(0,k.jsx)(`span`,{children:r.status||`Pending`})]})]}),(0,k.jsxs)(`div`,{className:`details-list-card`,children:[(0,k.jsxs)(`div`,{className:`detail-row`,children:[(0,k.jsxs)(`div`,{className:`row-left`,children:[(0,k.jsx)(he,{size:18,color:`#0b5d71`}),(0,k.jsx)(`span`,{className:`row-label`,children:`Speciality`})]}),(0,k.jsx)(`span`,{className:`row-value`,children:r.doctorSpecialty||`Cardiologist`})]}),(0,k.jsxs)(`div`,{className:`detail-row`,children:[(0,k.jsxs)(`div`,{className:`row-left`,children:[(0,k.jsx)(le,{size:18,color:`#0b5d71`}),(0,k.jsx)(`span`,{className:`row-label`,children:`Type`})]}),(0,k.jsx)(`span`,{className:`row-value`,children:r.consultationType||`In-person Visit`})]}),(0,k.jsxs)(`div`,{className:`detail-row`,children:[(0,k.jsxs)(`div`,{className:`row-left`,children:[(0,k.jsx)(de,{size:18,color:`#0b5d71`}),(0,k.jsx)(`span`,{className:`row-label`,children:`Day`})]}),(0,k.jsx)(`span`,{className:`row-value`,children:r.dayFormatted||`Friday`})]}),(0,k.jsxs)(`div`,{className:`detail-row`,children:[(0,k.jsxs)(`div`,{className:`row-left`,children:[(0,k.jsx)(de,{size:18,color:`#0b5d71`}),(0,k.jsx)(`span`,{className:`row-label`,children:`Date`})]}),(0,k.jsx)(`span`,{className:`row-value`,children:r.dateFormatted||`14/08/2026`})]}),(0,k.jsxs)(`div`,{className:`detail-row`,children:[(0,k.jsxs)(`div`,{className:`row-left`,children:[(0,k.jsx)(_e,{size:18,color:`#0b5d71`}),(0,k.jsx)(`span`,{className:`row-label`,children:`Time slot`})]}),(0,k.jsx)(`span`,{className:`row-value`,children:r.timeSlot||`09:30`})]}),(0,k.jsxs)(`div`,{className:`detail-row`,children:[(0,k.jsxs)(`div`,{className:`row-left`,children:[(0,k.jsx)(He,{size:18,color:`#0b5d71`}),(0,k.jsx)(`span`,{className:`row-label`,children:`Full name`})]}),(0,k.jsx)(`span`,{className:`row-value`,children:r.patientName||`Zunaira Mughal`})]}),(0,k.jsxs)(`div`,{className:`detail-row`,children:[(0,k.jsxs)(`div`,{className:`row-left`,children:[(0,k.jsx)(je,{size:18,color:`#0b5d71`}),(0,k.jsx)(`span`,{className:`row-label`,children:`Contact number`})]}),(0,k.jsx)(`span`,{className:`row-value`,children:r.contactNumber||`03010123456`})]})]}),r.status===`Cancelled`?(0,k.jsx)(`div`,{className:`cancelled-banner`,children:`Appointment Cancelled`}):(0,k.jsxs)(`button`,{className:`cancel-apt-btn`,onClick:async()=>{window.confirm(`Are you sure you want to cancel this appointment?`)&&(o(!0),cn(r.id),setTimeout(()=>{i({...r,status:`Cancelled`}),o(!1),n&&n(r.id)},400))},disabled:a,children:[(0,k.jsx)(ge,{size:18,color:`#be123c`}),(0,k.jsx)(`span`,{children:a?`Cancelling...`:`Cancel Appointment`})]})]}),(0,k.jsx)(`style`,{children:`
        .detail-screen {
          position: absolute;
          inset: 0;
          background: #f5f9fc;
      ...
      `})]})}function xn({onSelectAppointment:e,onBookNew:t}){let[n,r]=(0,_.useState)([]),[i,a]=(0,_.useState)(`all`);(0,_.useEffect)(()=>{let e=an();e.length>0?r(e):r([{id:`apt_demo_1`,doctorName:`Dr. Ahmed Ali`,doctorSpecialty:`Cardiologist (Heart)`,consultationType:`In-person Visit`,dayFormatted:`Friday`,dateFormatted:`14/08/2026`,timeSlot:`09:30 AM`,patientName:`Zunaira Mughal`,contactNumber:`03010123456`,status:`Pending`}])},[]);let o=n.filter(e=>{let t=(e.status||`Pending`).toLowerCase();return i===`upcoming`?t===`pending`||t===`accepted`||t===`confirmed`:i!==`history`||t===`completed`||t===`cancelled`||t===`declined`});return(0,k.jsxs)(`div`,{className:`visits-screen animate-fade-in`,children:[(0,k.jsxs)(`div`,{className:`visits-header-row`,children:[(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`h2`,{className:`header-title`,children:`Appointment History`}),(0,k.jsx)(`p`,{className:`header-subtitle`,children:`Track your medical bookings & consultation statuses`})]}),(0,k.jsxs)(`button`,{className:`new-booking-chip-btn`,onClick:t,children:[(0,k.jsx)(Me,{size:15}),` Book Visit`]})]}),(0,k.jsxs)(`div`,{className:`visits-tabs-bar`,children:[(0,k.jsxs)(`button`,{className:`tab-btn ${i===`all`?`active`:``}`,onClick:()=>a(`all`),children:[`All (`,n.length,`)`]}),(0,k.jsx)(`button`,{className:`tab-btn ${i===`upcoming`?`active`:``}`,onClick:()=>a(`upcoming`),children:`Active / Pending`}),(0,k.jsx)(`button`,{className:`tab-btn ${i===`history`?`active`:``}`,onClick:()=>a(`history`),children:`History`})]}),(0,k.jsx)(`div`,{className:`visits-list`,children:o.length===0?(0,k.jsxs)(`div`,{className:`empty-visits-card`,children:[(0,k.jsx)(de,{size:48,color:`#0b5d71`,opacity:.4}),(0,k.jsx)(`h4`,{className:`empty-title`,children:`No appointments found`}),(0,k.jsx)(`p`,{className:`empty-sub`,children:`You have no scheduled visits in this category.`}),(0,k.jsxs)(`button`,{className:`book-first-btn`,onClick:t,children:[(0,k.jsx)(Me,{size:16}),` Book New Appointment`]})]}):o.map(t=>{let n=(t.status||`Pending`).toLowerCase();return(0,k.jsxs)(`div`,{className:`visit-card animate-slide-up`,onClick:()=>e(t),children:[(0,k.jsxs)(`div`,{className:`visit-card-header`,children:[(0,k.jsxs)(`div`,{className:`doc-info-block`,children:[(0,k.jsx)(`h4`,{className:`visit-doc-name`,children:t.doctorName}),(0,k.jsx)(`p`,{className:`visit-spec`,children:t.doctorSpecialty})]}),(0,k.jsxs)(`span`,{className:`status-pill ${n}`,children:[n===`accepted`||n===`confirmed`?(0,k.jsx)(O,{size:12}):n===`declined`||n===`cancelled`?(0,k.jsx)(ge,{size:12}):(0,k.jsx)(_e,{size:12}),(0,k.jsx)(`span`,{children:t.status||`Pending`})]})]}),(0,k.jsxs)(`div`,{className:`visit-card-body`,children:[(0,k.jsxs)(`div`,{className:`meta-row`,children:[(0,k.jsx)(de,{size:14,color:`#0b5d71`}),(0,k.jsxs)(`span`,{children:[t.dayFormatted||`Friday`,`, `,t.dateFormatted||`14/08/2026`]})]}),(0,k.jsxs)(`div`,{className:`meta-row`,children:[(0,k.jsx)(_e,{size:14,color:`#0b5d71`}),(0,k.jsxs)(`span`,{children:[t.timeSlot||`09:30 AM`,` — `,(0,k.jsx)(`strong`,{style:{color:`#0b5d71`},children:t.consultationType})]})]}),(0,k.jsxs)(`div`,{className:`meta-row`,children:[(0,k.jsx)(je,{size:14,color:`#64748b`}),(0,k.jsxs)(`span`,{children:[`Patient: `,t.patientName,` (`,t.contactNumber,`)`]})]})]}),(0,k.jsxs)(`div`,{className:`visit-card-footer`,children:[(0,k.jsx)(`span`,{className:`view-detail-link`,children:`View Details & Pass Ticket`}),(0,k.jsx)(me,{size:16,color:`#0b5d71`})]})]},t.id)})}),(0,k.jsx)(`style`,{children:`
        .visits-screen {
          position: absolute;
          inset: 0;
          overflow-y: auto;
      ...
      `})]})}function Sn({user:e,onLogout:t}){let n=e?.role===`doctor`,[r,i]=(0,_.useState)(e?.image||``),[a,o]=(0,_.useState)(e?.fullName||``),[s,c]=(0,_.useState)(e?.specialty||`Cardiologist`),[l,u]=(0,_.useState)(e?.hospital||`Medic Care Hospital`),[d,f]=(0,_.useState)(e?.fee||`Rs. 2,500`),[p,m]=(0,_.useState)(!1),[h,g]=(0,_.useState)(!1);return(0,k.jsxs)(`div`,{className:`profile-screen animate-fade-in`,children:[(0,k.jsx)(`div`,{className:`profile-header`,children:(0,k.jsx)(`h2`,{className:`header-title`,children:`My Profile`})}),h&&(0,k.jsxs)(`div`,{className:`saved-alert-banner`,children:[(0,k.jsx)(O,{size:16}),(0,k.jsx)(`span`,{children:`Profile & photo updated successfully!`})]}),(0,k.jsxs)(`div`,{className:`profile-card`,children:[(0,k.jsxs)(`div`,{className:`avatar-uploader-wrapper`,children:[r?(0,k.jsx)(`img`,{src:r,alt:a,className:`profile-avatar-img`}):(0,k.jsx)(`div`,{className:`profile-avatar-fallback`,children:a?.charAt(0)||`U`}),(0,k.jsxs)(`label`,{htmlFor:`profile-pic-input`,className:`camera-overlay-badge`,title:`Upload new photo`,children:[(0,k.jsx)(fe,{size:14,color:`#ffffff`}),(0,k.jsx)(`input`,{id:`profile-pic-input`,type:`file`,accept:`image/*`,onChange:t=>{let r=t.target.files?.[0];if(r){let t=new FileReader;t.onloadend=()=>{let r=t.result;i(r);let a={...e,image:r};tn(a),n&&rn(a),g(!0),setTimeout(()=>g(!1),2e3)},t.readAsDataURL(r)}},style:{display:`none`}})]})]}),(0,k.jsxs)(`div`,{className:`profile-details`,children:[(0,k.jsx)(`h3`,{className:`profile-name`,children:a||`Zunaira Mughal`}),(0,k.jsx)(`p`,{className:`profile-email`,children:e?.email||`zunaira@gmail.com`}),(0,k.jsxs)(`div`,{className:`patient-tag ${n?`doctor-verified`:``}`,children:[(0,k.jsx)(Fe,{size:13}),(0,k.jsx)(`span`,{children:n?`Verified Doctor`:`Verified Patient`})]})]})]}),(0,k.jsxs)(`div`,{className:`menu-card`,children:[(0,k.jsxs)(`div`,{className:`menu-card-header`,children:[(0,k.jsx)(`h4`,{className:`card-section-title`,children:n?`Doctor Profile Details`:`Account Details`}),(0,k.jsx)(`button`,{className:`edit-toggle-btn`,onClick:()=>m(!p),children:p?`Cancel`:`Edit Profile`})]}),p?(0,k.jsxs)(`form`,{onSubmit:t=>{t.preventDefault();let i={...e,fullName:a,specialty:s,hospital:l,fee:d,image:r};tn(i),n&&rn(i),m(!1),g(!0),setTimeout(()=>g(!1),2e3)},className:`edit-profile-form`,children:[(0,k.jsxs)(`div`,{className:`edit-input-group`,children:[(0,k.jsx)(`label`,{className:`input-label`,children:`Full Name`}),(0,k.jsx)(`input`,{type:`text`,className:`edit-input`,value:a,onChange:e=>o(e.target.value),required:!0})]}),n&&(0,k.jsxs)(k.Fragment,{children:[(0,k.jsxs)(`div`,{className:`edit-input-group`,children:[(0,k.jsx)(`label`,{className:`input-label`,children:`Specialty`}),(0,k.jsx)(`input`,{type:`text`,className:`edit-input`,value:s,onChange:e=>c(e.target.value),required:!0})]}),(0,k.jsxs)(`div`,{className:`edit-input-group`,children:[(0,k.jsx)(`label`,{className:`input-label`,children:`Hospital / Clinic`}),(0,k.jsx)(`input`,{type:`text`,className:`edit-input`,value:l,onChange:e=>u(e.target.value),required:!0})]}),(0,k.jsxs)(`div`,{className:`edit-input-group`,children:[(0,k.jsx)(`label`,{className:`input-label`,children:`Consultation Fee`}),(0,k.jsx)(`input`,{type:`text`,className:`edit-input`,value:d,onChange:e=>f(e.target.value),required:!0})]})]}),(0,k.jsx)(`button`,{type:`submit`,className:`save-profile-btn`,children:`Save Changes`})]}):(0,k.jsxs)(`div`,{className:`profile-info-rows`,children:[n&&(0,k.jsxs)(k.Fragment,{children:[(0,k.jsxs)(`div`,{className:`info-row`,children:[(0,k.jsx)(ze,{size:16,color:`#0b5d71`}),(0,k.jsx)(`span`,{className:`row-label`,children:`Specialty:`}),(0,k.jsx)(`span`,{className:`row-val`,children:s})]}),(0,k.jsxs)(`div`,{className:`info-row`,children:[(0,k.jsx)(T,{size:16,color:`#0b5d71`}),(0,k.jsx)(`span`,{className:`row-label`,children:`Hospital:`}),(0,k.jsx)(`span`,{className:`row-val`,children:l})]}),(0,k.jsxs)(`div`,{className:`info-row`,children:[(0,k.jsx)(ye,{size:16,color:`#0b5d71`}),(0,k.jsx)(`span`,{className:`row-label`,children:`Fee:`}),(0,k.jsx)(`span`,{className:`row-val`,children:d})]})]}),(0,k.jsxs)(`div`,{className:`info-row`,children:[(0,k.jsx)(Oe,{size:16,color:`#0b5d71`}),(0,k.jsx)(`span`,{className:`row-label`,children:`Email:`}),(0,k.jsx)(`span`,{className:`row-val`,children:e?.email||`N/A`})]})]})]}),(0,k.jsxs)(`div`,{className:`db-status-card`,children:[(0,k.jsx)(ve,{size:20,color:`#f59e0b`}),(0,k.jsxs)(`div`,{children:[(0,k.jsx)(`h4`,{className:`db-title`,children:`Local Storage Mode`}),(0,k.jsx)(`p`,{className:`db-desc`,children:`Add VITE_SUPABASE_URL to .env to enable cloud sync.`})]})]}),(0,k.jsxs)(`button`,{className:`switch-role-btn`,onClick:()=>{tn(n?{fullName:`Zunaira Mughal`,email:`patient@medic.com`,role:`patient`}:{fullName:`Dr. Ahmed Ali`,email:`dr.ahmed@medic.com`,role:`doctor`,specialty:`Cardiologist`,hospital:`Medic Hospital`}),window.location.reload()},children:[(0,k.jsx)(He,{size:18}),(0,k.jsxs)(`span`,{children:[`Switch to `,n?`Patient Portal`:`Doctor Portal`,` (Demo)`]})]}),(0,k.jsxs)(`button`,{className:`logout-btn`,onClick:t,children:[(0,k.jsx)(De,{size:18}),(0,k.jsx)(`span`,{children:`Reset App (Logout)`})]}),(0,k.jsx)(`style`,{children:`
        .switch-role-btn {
          width: 100%;
          height: 48px;
          background: #e6f3f7;
      ...
      `})]})}function Cn({activeTab:e,onChangeTab:t}){return(0,k.jsxs)(`div`,{className:`bottom-nav-bar`,children:[[{id:`home`,label:`Home`,icon:Te},{id:`visits`,label:`My Visits`,icon:de},{id:`doctors`,label:`Doctors`,icon:Ue},{id:`profile`,label:`Profile`,icon:He}].map(n=>{let r=n.icon,i=e===n.id;return(0,k.jsxs)(`button`,{className:`nav-tab-item ${i?`active`:``}`,onClick:()=>t(n.id),children:[(0,k.jsx)(`div`,{className:`nav-icon-box ${i?`active-box`:``}`,children:(0,k.jsx)(r,{size:20,color:i?`#0b5d71`:`#94a3b8`,className:`tab-icon`})}),(0,k.jsx)(`span`,{className:`nav-label`,children:n.label})]},n.id)}),(0,k.jsx)(`style`,{children:`
        .bottom-nav-bar {
          position: absolute;
          bottom: 0;
          left: 0;
      ...
      `})]})}function wn(){let[e,t]=(0,_.useState)(`splash`),[n,r]=(0,_.useState)(`login`),[i,a]=(0,_.useState)(`home`),[o,s]=(0,_.useState)(()=>en()||{fullName:`Zunaira Mughal`,email:`zunaira@gmail.com`}),[c,l]=(0,_.useState)(null),[u,d]=(0,_.useState)(null),[f,p]=(0,_.useState)(!1),[m,h]=(0,_.useState)(!1),[g,v]=(0,_.useState)(null);(0,_.useEffect)(()=>{},[]);let y=()=>{let e=en();e?(s(e),t(`main`)):(s({fullName:`Zunaira Mughal`,email:`patient@medic.com`,role:`patient`,provider:`local`}),t(`main`))},b=e=>{r(e),t(`auth`)};return(0,k.jsxs)(Xe,{children:[e===`splash`&&(0,k.jsx)(Qe,{onFinish:y}),e===`onboarding`&&(0,k.jsx)($e,{onSignIn:()=>b(`login`),onCreateAccount:()=>b(`register`)}),e===`auth`&&(0,k.jsx)(fn,{isRegister:n===`register`,onAuthSuccess:e=>{s(e),t(`main`)},onBack:()=>t(`onboarding`)}),e===`main`&&(0,k.jsxs)(`div`,{style:{width:`100%`,height:`100%`,position:`relative`},children:[i===`home`&&(0,k.jsx)(mn,{user:o,onSelectDoctor:e=>l(e),onViewAllSpecialties:()=>p(!0),onViewAllDoctors:()=>h(!0)}),i===`visits`&&(0,k.jsx)(xn,{onSelectAppointment:e=>d(e),onBookNew:()=>h(!0)}),i===`doctors`&&(0,k.jsx)(vn,{onBack:()=>a(`home`),onSelectDoctor:e=>l(e)}),i===`profile`&&(0,k.jsx)(Sn,{user:o,onLogout:async()=>{await dn(),s({fullName:`Guest Patient`,email:``}),t(`onboarding`)}}),(0,k.jsx)(Cn,{activeTab:i,onChangeTab:e=>a(e)}),f&&(0,k.jsx)(gn,{onBack:()=>p(!1),onSelectSpecialty:e=>{p(!1),v(e.id),h(!0)}}),m&&(0,k.jsx)(vn,{onBack:()=>h(!1),onSelectDoctor:e=>{h(!1),l(e)},initialSpecialtyId:g}),c&&(0,k.jsx)(yn,{doctor:c,user:o,onBack:()=>l(null),onBookingSuccess:e=>{l(null),d(e)}}),u&&(0,k.jsx)(bn,{appointment:u,onBack:()=>d(null)})]})]})}(0,v.createRoot)(document.getElementById(`root`)).render((0,k.jsx)(_.StrictMode,{children:(0,k.jsx)(wn,{})}));